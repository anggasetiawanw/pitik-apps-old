...
class Transporter {
  ...
  void validate() {
    ...
    if (persistanceClass != null && persistanceClass != String) {
      ...
      if (!persistanceAs) {
        throw Exception('Persistance Class (As) not contains function static => toResponseModel. Please add to function static "toResponseModel"');
      }
    }
    ...
    if (persistanceClassError != null && persistanceClass != String) {
      ...
      if (!persistanceError) {
        throw Exception('Persistance Class (Error) not contains function static => toResponseModel. Please add to function static "toResponseModel"');
      }
    }
  }
  ...
  Future<dynamic> processing() async {
    if (method == 'POST') {
      ...
      if (isMultipart) {
        ...
        response = await _chuckerHttpClient
            .post(
              Uri.parse(baseUrl + path),
              headers: headers,
