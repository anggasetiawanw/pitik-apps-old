...
class TransactionSuccessActivity extends StatefulWidget {
  ...
  TransactionSuccessActivity(
      {super.key, this.showButtonClose = true, this.showButtonHome = true, this.showButtonShare = false, required this.keyPage, required this.message, required this.onTapClose, required this.onTapHome, this.onTapShare, this.icon});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        color: Colors.white,
        height: widget.showButtonHome && widget.showButtonClose && widget.showButtonShare
            ? 280
            : (widget.showButtonHome && widget.showButtonClose) || (widget.showButtonHome && widget.showButtonShare) || (widget.showButtonShare && widget.showButtonClose)
                ? 200
                : 120,
