...
class SmartScaleWeighingController extends GetxController {
  ...
  void addWeighing(SmartScaleRecord? dataParam) {
    if (totalChicken.getInput() == '' && dataParam == null) {
      ...
      if (dataParam != null) {
        ...
        smartScaleRecord = SmartScaleRecord(section: idx, count: totalChicken.getInputNumber()!.toInt(), weight: totalWeighing.getInputNumber(), totalCount: totalChicken.getInputNumber()!.toInt(), totalWeight: totalWeighing.getInputNumber());
      }
      smartScaleRecords.putIfAbsent(idx, () => smartScaleRecord);

      final EditField totalChick =
          EditField(controller: GetXCreator.putEditFieldController("totalChickenAdd$idx"), label: "", hint: "", alertText: "", hideLabel: true, textUnit: "Ekor", inputType: TextInputType.number, maxInput: 10, onTyping: (text, editField) {});

      final EditField totalWeight =
          EditField(controller: GetXCreator.putEditFieldController("totalWeighingAdd$idx"), label: "", hint: "", alertText: "", hideLabel: true, textUnit: "kg", inputType: TextInputType.number, maxInput: 10, onTyping: (text, editField) {});
      ...
      _setOutstandingWeighing();
      smartScaleDataWidget.putIfAbsent(
          idx,
    ...
    smartScaleDataWidget.forEach((key, value) {
      final numberField = Padding(
          ...
          child: Container(
              ...
              child: Padding(padding: const EdgeInsets.only(bottom: 5), child: Center(child: Text('$indexNumber', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: const Color(0xFF9E9D9D)))))));
  ...
  void onInit() {
    ...
    bluetoothLeService = BluetoothLeService().timeout(true, 5).start(
        BluetoothLeConstant.TEXT_RESULT,
        ['PTK-SCL'],
        BluetoothLeCallback(
            onLeReceived: (data) {
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(
                            child: RawScrollbar(
                                ...
                                child: Padding(
                                  ...
                                  child: ListView(
                                      children: smartScaleRecords.entries
                                          .map((e) => Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Padding(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Expanded(child: ButtonFill(controller: GetXCreator.putButtonFillController("bfYesSaveSmartScaleWeighing"), label: "Ya", onClick: () => _pushSmartScaleData())),
      ...
      smartScaleDataWidget.forEach((key, value) {
        if (idx == 10) {
          ...
          data.add(Row(
            ...
            children: [smartScaleDataWidgetNumber[key]!, Expanded(child: smartScaleDataWidget[key]!)],
          ));
