  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Obx(() => Stack(children: [
              controller.isLoading.isTrue
                  ...
                  : Padding(
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [Expanded(child: controller.totalWeighingField), const SizedBox(width: 8), Expanded(child: controller.outstandingTotalWeighingField)]),
                        Padding(
                                ...
                                child: controller.isTimeout.isTrue
                                    ? Container(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: SvgPicture.asset('images/add_orange_icon.svg',
                                              width: 16,
                                              height: 16,
                                              // ignore: deprecated_member_use
                                              color: GlobalVar.grayLightText),
                                          onTap: () {},
                                        ))
                                    : Container(
                                        width: 32,
              ...
              if (controller.isLoading.isTrue) ...[const SizedBox()] else ...[bottomNavBar()]
            ])));
  }
