              ...
              controller.isLoading.isTrue
                  ...
                  : RefreshIndicator(
                      child: controller.smartScaleList.isEmpty
                          ...
                          : Column(children: [const SizedBox(height: 16), filterContainer(context), Expanded(child: listSmartScale())]),
  ...
  Widget listSmartScale() => Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Column(children: [controller.bundle.onCreateCard(controller, index), index == controller.smartScaleList.length - 1 ? const SizedBox(height: 120) : Container()]);
          }));
}
