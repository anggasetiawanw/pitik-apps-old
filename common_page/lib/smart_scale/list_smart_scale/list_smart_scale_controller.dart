...
class ListSmartScaleController extends GetxController {
    ...
    void onInit() {
        ...
        dateFilterField = DateTimeField(controller: GetXCreator.putDateTimeFieldController("filterListSmartScale"), label: "Pilih Tanggal", hint: "2023/08/15", alertText: "Tanggal harus pilih..!",
