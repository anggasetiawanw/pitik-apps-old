...
class SmartScaleWeighingBundle {
  ...
  SmartScaleWeighingBundle({required this.routeSave, required this.routeEdit, required this.routeDetail, required this.getBodyRequest, required this.getBodyDetail, this.saveToDb = true, this.weighingNumber, this.onGetSubmitResponse});
}
