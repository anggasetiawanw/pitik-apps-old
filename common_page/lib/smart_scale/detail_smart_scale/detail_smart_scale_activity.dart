                        ...
                        Container(
                            ...
                            child: Padding(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  controller.smartScale.value.startDate != null
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(SmartScaleAdditionalUtil.getStartWeighing(controller.smartScale.value), style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                                          ],
                                        )
                                      : controller.smartScale.value.date != null
                                          ? Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                ...
                                                Text(SmartScaleAdditionalUtil.getDateWeighing(controller.smartScale.value), style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                                              ],
                                            )
                                          : const SizedBox(),
                                  controller.smartScale.value.executionDate != null
                                      ? Column(
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(SmartScaleAdditionalUtil.getEndWeighing(controller.smartScale.value), style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                                              ],
                                            )
                                          ],
                                        )
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("${SmartScaleAdditionalUtil.getTotalChicken(controller.smartScale.value)} Ekor", style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                                    ],
                                  ),
                                  const SizedBox(height: 8),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("${SmartScaleAdditionalUtil.getTonase(controller.smartScale.value).toStringAsFixed(2)} kg", style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                                    ],
                                  ),
                                  const SizedBox(height: 8),
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("${SmartScaleAdditionalUtil.getAverageWeight(controller.smartScale.value).toStringAsFixed(2)} kg",
                          ...
                          for (int i = 0; i < controller.smartScale.value.details.length; i++) ...[
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text("${i + 1}", style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                  Text("${controller.smartScale.value.details[i]!.totalCount} Ekor", style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                  Text("${controller.smartScale.value.details[i]!.totalWeight!.toStringAsFixed(2)} kg", style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                ],
                              ),
                            ),
                            const SizedBox(height: 4),
