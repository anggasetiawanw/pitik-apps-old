    ...
    return Scaffold(
        ...
        body: Padding(
            ...
            child: Obx(() => RefreshIndicator(
                ...
                onRefresh: () => Future.delayed(const Duration(milliseconds: 200), () => controller.refreshData()),
                child: NotificationListener<ScrollEndNotification>(
                    ...
                    child: ListView(physics: const AlwaysScrollableScrollPhysics(), children: [
                      Container(
                          decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(8)), border: Border.all(width: 1, color: GlobalVar.outlineColor), color: Colors.white),
                                    ...
                                    : Column(children: [
                                        ...
                                        Padding(
                                            ...
                                            child: Column(children: [
                                              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                                Text(
                                                    'Proyeksi Sekarang\n(Hari ke ${controller.tabProjectionSelected.value == 0 ? controller.getDayNum(data: controller.projectionData.value!.weight) : controller.tabProjectionSelected.value == 1 ? controller.getDayNum(data: controller.projectionData.value!.fcr) : controller.getDayNum(data: controller.projectionData.value!.mortality)})',
                                                    style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText),
                                                    textAlign: TextAlign.center),
                                                const SizedBox(width: 16),
                                                Text(
                                                    'Proyeksi Sekarang\n(Hari ke ${controller.tabProjectionSelected.value == 0 ? controller.getDayNum(data: controller.projectionData.value!.weight, isCurrent: false) : controller.tabProjectionSelected.value == 1 ? controller.getDayNum(data: controller.projectionData.value!.fcr, isCurrent: false) : controller.getDayNum(data: controller.projectionData.value!.mortality)})',
                                                    style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText),
                                                    textAlign: TextAlign.center)
                                              ]),
                                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                SizedBox(
                                                  ...
                                                  child: SfCartesianChart(isTransposed: true, enableAxisAnimation: true, primaryXAxis: NumericAxis(isVisible: false), series: <BarSeries<FarmProjectionDetail?, dynamic>>[
                                                    BarSeries<FarmProjectionDetail?, dynamic>(
                                                      ...
                                                      dataSource: [
                                                        controller.tabProjectionSelected.value == 0
                                                            ? controller.projectionData.value!.weight
                                                            : controller.tabProjectionSelected.value == 1
                                                                ? controller.projectionData.value!.fcr
                                              ...
                                              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                                Text(
                                                    controller.tabProjectionSelected.value == 0
                                                        ? controller.getWeek(controller.projectionData.value!.weight)
                                                        : controller.tabProjectionSelected.value == 1
                                                            ? controller.getWeek(controller.projectionData.value!.fcr)
                                              ...
                                              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                                Column(children: [
                                                  Row(children: [
                                                    Container(width: 20, height: 8, decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(4)), color: GlobalVar.primaryOrange)),
                                                    const SizedBox(width: 8),
                                                    Text('Aktual (gram)', style: GlobalVar.subTextStyle.copyWith(fontSize: 10, fontWeight: GlobalVar.medium, color: GlobalVar.grayText))
                                                  ]),
                                                  const SizedBox(height: 4),
                                                  Row(children: [
                                                    Container(width: 20, height: 8, decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(4)), color: GlobalVar.primaryLight2)),
                                                    const SizedBox(width: 8),
                      ...
                      controller.isActual.isTrue && controller.isLoading.isFalse
                          ? Column(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text('Tanggal Chickin ${controller.coop.value == null ? '-' : controller.coop.value!.startDate ?? '-'}',
                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                  ],
                                ),
                                const SizedBox(height: 16),
                                Column(
                                    children: List.generate(
                                        controller.farmPerformanceHistory.length,
                                        (index) => Padding(
                                            ...
                                            child: Container(
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    const SizedBox(width: 8),
                                                    Text(controller.farmPerformanceHistory[index]!.estimatedPopulation == null ? '-' : controller.farmPerformanceHistory[index]!.estimatedPopulation!.toStringAsFixed(0),
                                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                  ]),
                                                  const SizedBox(height: 8),
                                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    const SizedBox(width: 8),
                                                    Text(controller.farmPerformanceHistory[index]!.fcr == null ? '-' : controller.farmPerformanceHistory[index]!.fcr!.toStringAsFixed(1),
                                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                  ]),
                                                  const SizedBox(height: 8),
                                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    Text('Berat rata-rata', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                    const SizedBox(width: 8),
                                                    Text(controller.farmPerformanceHistory[index]!.abw == null ? '-' : controller.farmPerformanceHistory[index]!.abw!.toStringAsFixed(1),
                                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                  ]),
                                                  const SizedBox(height: 8),
                                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    const SizedBox(width: 8),
                                                    Text(controller.farmPerformanceHistory[index]!.mortality == null ? '-' : controller.farmPerformanceHistory[index]!.mortality!.toStringAsFixed(0),
                                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                  ]),
                                                  const SizedBox(height: 8),
                                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    const SizedBox(width: 8),
                                                    Text(controller.farmPerformanceHistory[index]!.feedConsumption == null ? '-' : '${controller.farmPerformanceHistory[index]!.feedConsumption!.toStringAsFixed(0)} Karung',
                                                        style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                  ])
                                                ])))))
                              ],
