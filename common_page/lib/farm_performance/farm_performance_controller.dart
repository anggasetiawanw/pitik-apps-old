  ...
  void toActual() => AuthImpl().get().then((auth) {
        ...
        if (auth != null) {
          if (coop.value != null && coop.value!.farmingCycleId != null) {
            ...
            Get.snackbar("Pesan", "Data Kandang masih di proses, silahkan kembali ke beranda, lalu buka Performa kembali setelah data kandang telah selesai di proses..!",
                snackPosition: SnackPosition.TOP, colorText: Colors.white, backgroundColor: Colors.red);
          }
        } else {
