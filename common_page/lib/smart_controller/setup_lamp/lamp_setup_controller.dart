...
class LampSetupController extends GetxController {
    ...
    void onInit() {
        ...
        boNoSettingLamp = ButtonOutline(
            controller: GetXCreator.putButtonOutlineController("boNoRegBuildingLamp"),
            label: "Tidak",
            onClick: () => Get.back()
        );
        bfYesSettingLamp = ButtonFill(
            controller: GetXCreator.putButtonFillController("bfYesSettingLamp"),
            label: "Ya",
            onClick: () => settingLamp()
        );
    }
                        ...
                        listener: ResponseListener(
                            onResponseDone: (code, message, body, id, packet) {
                                ...
                                Get.off(TransactionSuccessActivity(
                                    keyPage: "smartLampSaved",
                                    message: "Kamu telah berhasil melakukan pengaturan Lampu",
    ...
    DeviceSetting generatePayloadLampSetup() => DeviceSetting(
        id: lamp.id,
                        ...
                        children: [
                            ...
                            Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                        Expanded(child: bfYesSettingLamp),
                                        const SizedBox(width: 16),
                                        Expanded(child: boNoSettingLamp)
                                    ]
                                )
                            ),
