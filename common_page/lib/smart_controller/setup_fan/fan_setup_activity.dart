                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Expanded(
                      child: Obx(() => controller.isEdit.isTrue
                          ? ButtonFill(controller: GetXCreator.putButtonFillController("bfSaveFanSetup"), label: "Simpan", onClick: () => controller.showBottomDialog(context))
                          : ButtonFill(
              ...
              Obx(() => controller.isLoading.isTrue
                  ...
                  : SingleChildScrollView(
                      child: Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [controller.sbIntermittern, controller.efDiffTemp, controller.tmPickerDurationOn, controller.tmPickerFanOffDurartion, const SizedBox(height: 120)])))),
              bottomNavBar()
            ])));
  }
}
