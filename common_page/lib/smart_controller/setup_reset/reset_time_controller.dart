...
class ResetTimeController extends GetxController {
  ...
  void onInit() {
    ...
    bfSaveResetTime = ButtonFill(controller: GetXCreator.putButtonFillController("bfSaveResetTime"), label: "Simpan", onClick: () => showBottomDialog(context));
    ...
    boNoResetTime = ButtonOutline(controller: GetXCreator.putButtonOutlineController("boNoResetTime"), label: "Tidak", onClick: () => Get.back());
    bfYesResetTime = ButtonFill(controller: GetXCreator.putButtonFillController("bfYesResetTime"), label: "Ya", onClick: () => resetTime());
