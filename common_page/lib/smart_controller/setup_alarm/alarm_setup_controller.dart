                        ...
                        listener:ResponseListener(
                            onResponseDone: (code, message, body, id, packet) {
                                ...
                                Get.off(TransactionSuccessActivity(
                                    keyPage: "smartAlarmSaved",
                                    message: "Kamu telah berhasil melakukan pengaturan Alarm",
                            ...
                            onResponseFail: (code, message, body, id, packet) {
                                isLoading.value = false;
                                Get.snackbar(
                                    "Alert", (body as ErrorResponse).error!.message!, snackPosition: SnackPosition.TOP,
                            ...
                            onResponseError: (exception, stacktrace, id, packet) {
                                isLoading.value = false;
                                Get.snackbar(
                                    "Alert","Terjadi kesalahan internal", snackPosition: SnackPosition.TOP,
                                    duration: const Duration(seconds: 5),
                                    backgroundColor: Colors.red,
                                    colorText: Colors.white
                                );
                        ...
                        children: [
                            ...
                            Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                        Expanded(child: bfYesSetAlarm),
                                        const SizedBox(width: 16),
                                        Expanded(child: boNoSetAlarm)
                                    ]
                                )
                            ),
