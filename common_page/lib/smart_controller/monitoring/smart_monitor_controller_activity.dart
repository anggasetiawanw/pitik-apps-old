        ...
        child: Scaffold(
            ...
            body: Padding(
                ...
                child: DetailSmartMonitor(
                    controller: Get.put(DetailSmartMonitorController(tag: "smartMonitorForController", context: Get.context!, coop: controller.coop, useBundleLatestCondition: true, bundleLatestCondition: controller.deviceSummary),
