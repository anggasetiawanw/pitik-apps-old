  ...
  Widget build(BuildContext context) {
                  ...
                  child: Stack(children: [
                    Container(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          GestureDetector(
                            child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start, children: [const SizedBox(width: 8), DefaultTextStyle(style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium), child: const Text("Edit"))]),
                            onTap: () {
                          ...
                          GestureDetector(
                              child: Row(
                                  ...
                                  children: [const SizedBox(width: 8), DefaultTextStyle(style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium), child: const Text("Ubah Nama"))]),
                              onTap: () {
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
            ...
            backgroundColor: Colors.white,
            onRefresh: () => Future.delayed(const Duration(milliseconds: 200), () => controller.getDetailSmartController()),
            child: Stack(children: [
              Container(
                  ...
                  child: Obx(() => controller.isLoading.isTrue
                      ...
                      : controller.deviceController == null
                          ...
                          : SingleChildScrollView(
                              child: Column(children: [Container(margin: const EdgeInsets.only(bottom: 10, right: 4, left: 4), child: controller.monitorContainer.value), controller.itemGridview(MediaQuery.of(context).size.width)]))))
            ])));
  }
}
