...
class DashboardLampController extends GetxController {
        ...
        if (auth != null) {
          ...
          Service.push(
              ...
              body: [
                ...
                auth.id,
                GlobalVar.xAppId ?? '-',
                ListApi.pathDeviceData(basePath, "lamp", isForPitikConnect ? device.deviceSummary!.coopCodeId! : device.coopId ?? '-', isForPitikConnect ? device.deviceSummary!.deviceId! : device.deviceId ?? '-')
              ],
  ...
  Widget createLampList() => Expanded(
        ...
        onRefresh: () => Future.delayed(const Duration(milliseconds: 200), () => getDataLamps()),
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(color: lamps.value[index].error == false ? Colors.white : const Color(0xFFFDDFD1), border: Border.all(width: 1, color: GlobalVar.outlineColor), borderRadius: BorderRadius.circular(8)),
