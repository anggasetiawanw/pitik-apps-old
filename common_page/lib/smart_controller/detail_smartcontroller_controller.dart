        ...
        if (auth != null) {
          ...
          Service.push(
              ...
              body: [
                ...
                auth.id,
                GlobalVar.xAppId ?? '',
                ListApi.pathDeviceData(basePath, 'summary', modifySmartMonitorPage != null ? device.deviceSummary!.coopCodeId! : device.coopId ?? '-', modifySmartMonitorPage != null ? device.deviceSummary!.deviceId! : device.deviceId ?? '-')
              ],
                      ...
                      if ((body as FloorListResponse).data != null) {
                        for (var floor in body.data!.floor) {
                          if (floor != null && floor.deviceId == device.deviceId) {
                            device.deviceSummary = DeviceSummary(temperature: SensorData(value: floor.temperature ?? 0.0, status: 'good', uom: '°C'), relativeHumidity: SensorData(value: floor.humidity ?? 0.0, status: 'bad', uom: '%'));
                  ...
                  child: Padding(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: index == 0 && deviceController!.growthDay != null
                                  ? null
                                  : index == 0 && deviceController!.growthDay == null
                                      ? const Color(0xFFFDDFD1)
                                      : index == 1 && deviceController!.fan != null
                                          ? null
                                          : index == 1 && deviceController!.fan == null
                                              ? const Color(0xFFFDDFD1)
                                              : index == 2 && deviceController!.heater != null
                                                  ? null
                                                  : index == 2 && deviceController!.heater == null
                                                      ? const Color(0xFFFDDFD1)
                                                      : index == 3 && deviceController!.cooler != null
                                                          ? null
                                                          : index == 3 && deviceController!.cooler == null
                                                              ? const Color(0xFFFDDFD1)
                                                              : index == 4 && deviceController!.lamp != null
                                                                  ? null
                                                                  : index == 4 && deviceController!.lamp == null
                                                                      ? const Color(0xFFFDDFD1)
                                                                      : index == 5 && deviceController!.alarm != null
                                                                          ? null
                                                                          : index == 5 && deviceController!.alarm == null
                                                                              ? const Color(0xFFFDDFD1)
                                                                              : index == 6 && deviceController!.resetTime != null
                                                                                  ? null
                                                                                  : index == 6 && deviceController!.resetTime == null
                                                                                      ? const Color(0xFFFDDFD1)
                                                                                      : null,
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                    child: index == 0 && (deviceController!.growthDay == null || deviceController!.growthDay!.status == false)
                                        ? SvgPicture.asset("images/growth_icon.svg")
                                        : index == 0 && deviceController!.growthDay != null && deviceController!.growthDay!.status! == true
                                            ? SvgPicture.asset("images/growth_icon.svg")
                                            : index == 1 && deviceController!.fan != null && deviceController!.fan!.status! == true
                                                ? SvgPicture.asset("images/fan_icon.svg")
                                                : index == 1 && (deviceController!.fan == null || deviceController!.fan!.status! == false)
                                                    ? SvgPicture.asset("images/fan_error_icon.svg")
                                                    : index == 2 && deviceController!.heater != null && deviceController!.heater!.status! == true
                                                        ? SvgPicture.asset("images/heater_icon.svg")
                                                        : index == 2 && (deviceController!.heater == null || deviceController!.heater!.status! == false)
                                                            ? SvgPicture.asset("images/heater_warning_icon.svg")
                                                            : index == 3 && deviceController!.cooler != null && deviceController!.cooler!.status! == true
                                                                ? SvgPicture.asset("images/cooler_icon.svg")
                                                                : index == 3 && (deviceController!.cooler == null || deviceController!.cooler!.status! == false)
                                                                    ? SvgPicture.asset("images/cooler_error_icon.svg")
                                                                    : index == 4 && deviceController!.lamp != null && deviceController!.lamp!.status! == true
                                                                        ? SvgPicture.asset("images/lamp_icon.svg")
                                                                        : index == 4 && (deviceController!.lamp == null || deviceController!.lamp!.status! == false)
                                                                            ? SvgPicture.asset("images/lamp_icon.svg")
                                                                            : index == 5 && deviceController!.alarm != null
                                ...
                                index == 0
                                    ? DeviceStatus(status: deviceController!.growthDay!.status!, activeString: "Aktif", inactiveString: "Non-Aktif")
                                    : index == 1
                                        ? DeviceStatus(status: deviceController!.fan!.status!, activeString: "Aktif", inactiveString: "Non-Aktif")
                                        : index == 2
                                            ? DeviceStatus(status: deviceController!.heater!.status!, activeString: "Nyala", inactiveString: "Mati")
                                            : index == 3
                                                ? DeviceStatus(status: deviceController!.cooler!.status!, activeString: "Nyala", inactiveString: "Mati")
                                                : index == 4
                                                    ? DeviceStatus(status: deviceController!.lamp!.status!, activeString: "Nyala", inactiveString: "Mati")
                                                    : index == 5
                                                        ? const DeviceStatus(status: true, activeString: "Normal", inactiveString: "Error")
                                                        : index == 6
                                ...
                                Row(children: [
                                  Expanded(
                                    child: index == 0
                                        ...
                                        : index == 1
                                            ? Text("Nyala ${deviceController!.fan!.online} - Mati ${deviceController!.fan!.offline} ", style: GlobalVar.greyTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 12))
                                            : index == 2
                                                ? RichText(
                                                    text: TextSpan(
