...
class GrowthSetupController extends GetxController {
    ...
    late EditField efAge = EditField(
        controller: GetXCreator.putEditFieldController("efAge"),
        label: "Umur",
        hint: "Ketik disini",
                    ...
                    Service.push(
                        ...
                        body: [
                            ...
                            ListApi.pathSetController(
                                ...
                                "growth-day",
                                isForPitikConnect ? device.deviceSummary!.coopCodeId! : device.coopId ?? '-',
                                forPitikConnect: isForPitikConnect,
                                idForNonPitikConnect: controllerData.id ?? '-'
                            ),
                        ...
                        listener:ResponseListener(
                            onResponseDone: (code, message, body, id, packet) {
                                ...
                                Get.off(TransactionSuccessActivity(
                                    keyPage: "smartGrowthDaySaved",
                                    message: "Kamu telah berhasil melakukan pengaturan Masa Tumbuh",
        ...
        List<TemperatureReduction?> temperatureReductions = [];
            for (int i = 0; i < itemDecreaseTemperature.controller.itemCount.value; i++) {
                ...
                temperatureReductions.add(TemperatureReduction(
                    day: (itemDecreaseTemperature.controller.efDayTotal.value[whichItem].getInputNumber())!.toInt(),
                    reduction: itemDecreaseTemperature.controller.efDecreaseTemp.value[whichItem].getInputNumber(),
                    group: "${whichItem + 1}"
                ));
        }
