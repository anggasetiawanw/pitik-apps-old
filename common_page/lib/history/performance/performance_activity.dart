    ...
    return Obx(() => Column(
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              controller.isTableShow.isFalse
                  ? Padding(
              ...
              Padding(
                  ...
                  child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(8)), color: GlobalVar.primaryLight2),
                        child: Row(
                          children: [
                    ...
                    children: [
                      Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                            Container(
                              width: 8,
                              height: 8,
                              decoration: const BoxDecoration(color: GlobalVar.primaryOrange, shape: BoxShape.circle),
                            ),
                            ...
                            Container(
                              width: 8,
                              height: 8,
                              decoration: const BoxDecoration(color: GlobalVar.headerSku, shape: BoxShape.circle),
                            ),
                            const SizedBox(width: 4),
                      ...
                      Padding(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(8)), border: Border.all(width: 1, color: GlobalVar.outlineColor)),
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [Text('Performa Setiap Hari', style: GlobalVar.subTextStyle.copyWith(fontSize: 16, fontWeight: GlobalVar.medium, color: GlobalVar.primaryOrange)), controller.datePerformanceField.value],
                                ),
                                Text('Hari ${controller.detailPerformance.value == null || controller.detailPerformance.value!.day == null ? '-' : controller.detailPerformance.value!.day}',
                                ...
                                Row(
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    SizedBox(width: (MediaQuery.of(Get.context!).size.width / 2) * 0.3, child: Text('Variabel', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold, color: GlobalVar.black))),
                                    SizedBox(width: (MediaQuery.of(Get.context!).size.width / 2) * 0.3, child: Text('Saat Ini', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold, color: GlobalVar.black))),
                                    SizedBox(
                                ...
                                _createAttributeDetail(
                                    ...
                                    current: controller.detailPerformance.value == null || controller.detailPerformance.value!.population == null || controller.detailPerformance.value!.population!.total == null
                                        ? null
                                        : controller.detailPerformance.value!.population!.total!.toDouble(),
                                    standard: null),
                                _createAttributeDetail(
                                    variable: 'Sisa Populasi',
                                    current: controller.detailPerformance.value == null || controller.detailPerformance.value!.population == null || controller.detailPerformance.value!.population!.remaining == null
                                        ? null
                                ...
                                _createAttributeDetail(
                                    ...
                                    current: controller.detailPerformance.value == null || controller.detailPerformance.value!.population == null || controller.detailPerformance.value!.population!.harvested == null
                                        ? null
                                ...
                                _createAttributeDetail(
                                    ...
                                    current: controller.detailPerformance.value == null || controller.detailPerformance.value!.population == null || controller.detailPerformance.value!.population!.mortality == null
                                        ? null
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width: 2,
                                          height: 2,
                                          decoration: const BoxDecoration(color: GlobalVar.black, shape: BoxShape.circle),
                                        ),
                                        const SizedBox(width: 4),
                                    ...
                                    Expanded(
                                        child: Text(
                                      controller.getFeedDatePrediction(),
                                      style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold, color: GlobalVar.black),
                                      textAlign: TextAlign.center,
                                    )),
                                    Expanded(child: Text('-', textAlign: TextAlign.end, style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold, color: GlobalVar.black)))
                                  ],
                                )
                              ])))
                    ],
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              child: Text(standard == null ? '-' : Convert.toCurrencyWithoutDecimal(standard.toStringAsFixed(0), '', '.'),
                  textAlign: TextAlign.end, style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold, color: GlobalVar.black)))
        ],
      ),
    );
  }
