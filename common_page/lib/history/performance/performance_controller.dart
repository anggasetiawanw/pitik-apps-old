...
class PerformanceController extends GetxController {
  ...
  void onInit() {
    ...
    performSpField = SpinnerField(
        ...
        hint: "",
        alertText: "",
        items: const {"BW": true, "IP": false, "FCR": false, "Mortality": false},
                  ...
                  listener: ResponseListener(
                      onResponseDone: (code, message, body, id, packet) {
                        List<List<String>> data = [
                          ["Hari", "Bobot", "Pakan", "Kematian", "Culling", "OVK", "FCR", "IP"]
                        ];
              ...
              Service.push(
                  ...
                  listener: ResponseListener(
                      onResponseDone: (code, message, body, id, packet) {
                        ...
                        SpinnerField spinner = SpinnerField(
                            controller: GetXCreator.putSpinnerFieldController("datePerformanceField"),
                            label: "",
                            hideLabel: true,
                            hint: "",
                            alertText: "",
                        ...
                        datePerformanceField.value = SizedBox(width: 120, child: spinner);
  ...
  void _reconditionEmptySpaceBar() {
    ...
    if (outstanding < 1) {
      ...
      for (int i = 1; i <= addEmptyData; i++) {
        barData.add(CoopActiveStandard(day: barData.length + i, actual: 0, standard: 0));
      }
    }
  }
}
