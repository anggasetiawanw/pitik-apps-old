        ...
        return Stack(children: [
          ListTile(
            ...
            ItemHistoricalSmartCamera(
                controller: GetXCreator.putHistoricalSmartCameraController("ItemHistoricalSmartCamera$index}", context), recordCamera: recordImages.value[index], index: index, isCanCrowdednessCorrection: !bundle.isCanTakePicture, onOptionTap: () {}),
          ...
          Container(
              ...
              child: ListTile(
                  trailing: PopupMenuButton(
                      ...
                      itemBuilder: (context) {
                        return [
                          PopupMenuItem(value: 'Bagikan', child: Text("Bagikan", style: GlobalVar.blackTextStyle.copyWith(fontSize: 14))),
                          PopupMenuItem(value: 'Download', child: Text('Download', style: GlobalVar.blackTextStyle.copyWith(fontSize: 14)))
                        ];
                      },
