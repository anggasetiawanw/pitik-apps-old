  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: controller.recordImages.isEmpty
                ? Center(
                    child: Container(
                    ...
                    Container(
                        ...
                        child: Column(children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Obx(() => Text("${controller.totalCamera}", style: GlobalVar.greyTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium), overflow: TextOverflow.clip))
                          ])
                        ])),
