      ...
      itemBuilder: (context, index) {
        ...
        return Stack(children: [
          ListTile(
            ...
            ItemTakePictureCamera(controller: GetXCreator.putItemTakePictureController("ItemTakePictureCamera$index", context), recordCamera: recordImages[index], index: index, onOptionTap: () {}),
