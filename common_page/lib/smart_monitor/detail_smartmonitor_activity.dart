...
class DetailSmartMonitor extends StatelessWidget {
  ...
  DetailSmartMonitor(
      ...
      this.device,
      this.widgetLoading,
      this.modifySmartMonitorPage,
      this.deviceIdForController,
      this.coopIdForController,
      this.bundleLatestCondition,
      this.hideBuildings = false,
      this.hideTemperature = false,
      this.hideHumidity = false,
      this.hideHeatStress = false,
      this.hideAmmonia = false,
      this.hideWind = false,
  ...
  Widget build(BuildContext context) {
    ...
    Widget customExpandable(String sensorType, String icon, SensorData? sensorData) {
      if (device == null) {
        return ExpandableMonitorRealTime(
          ...
          headerText: sensorType == "temperature"
              ? "Temperatur"
          ...
          valueTextColor: sensorData == null || sensorData.status == null
              ? 0xFF2C2B2B
              : sensorData.status == "good"
                  ...
                  : sensorData.status == "bad"
                      ...
                      : 0xFF2C2B2B,
          icon: icon,
          unitValue: sensorData == null || sensorData.uom == null
              ? ''
          ...
          targetLabel: sensorType == "temperature"
              ? "Target"
              : sensorType == "relativeHumidity"
                  ? "Target"
                  : sensorType == "heatStressIndex"
                      ...
                      : sensorType == "wind"
                          ...
                          : sensorType == "lights"
                              ...
                              : sensorType == "ammonia"
                                  ? "Standard"
                                  : "",
          averageLabel: sensorType == "temperature"
              ? "Rata-Rata"
              : sensorType == "relativeHumidity"
                  ? "Rata-Rata"
                  : sensorType == "heatStressIndexs"
                      ? "Siklus Sekarang"
                      : sensorType == "wind"
                          ? "Siklus Sekarang"
                          : sensorType == "lights"
    ...
    return Obx(() => Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () => Future.delayed(const Duration(milliseconds: 200), () => controller.getInitialLatestDataSmartMonitor()),
            child: Stack(children: [
              controller.isLoading.isTrue
                  ? (widgetLoading == null ? const Center(child: ProgressLoading()) : widgetLoading!)
                  : ListView(physics: const AlwaysScrollableScrollPhysics(), children: [
                      ...
                      Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            !hideTemperature
                                ? customExpandable("temperature", "images/temperature_icon.svg", controller.deviceSummary.value == null || controller.deviceSummary.value!.temperature == null ? null : controller.deviceSummary.value!.temperature)
                                : const SizedBox(),
                            !hideHumidity
                                ? customExpandable(
                                    "relativeHumidity", "images/humidity_icon.svg", controller.deviceSummary.value == null || controller.deviceSummary.value!.relativeHumidity == null ? null : controller.deviceSummary.value!.relativeHumidity)
                                : const SizedBox(),
                            !hideHeatStress
                                ? customExpandable(
                                    "heatStressIndex", "images/heater_icon.svg", controller.deviceSummary.value == null || controller.deviceSummary.value!.heatStressIndex == null ? null : controller.deviceSummary.value!.heatStressIndex)
                                : const SizedBox(),
                            !hideAmmonia
                                ? customExpandable("ammonia", "images/amonia_icon.svg", controller.deviceSummary.value == null || controller.deviceSummary.value!.ammonia == null ? null : controller.deviceSummary.value!.ammonia)
                                : const SizedBox(),
