...
class NewDataPurchase extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final NewDataPurchaseController controller =
    Get.put(NewDataPurchaseController(context: context));
  ...
  _showBottomDialog(BuildContext context, NewDataPurchaseController controller, String status) {
