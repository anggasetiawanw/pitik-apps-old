...
class EditDataPurchase extends StatelessWidget {
  const EditDataPurchase({super.key});

  @override
  Widget build(BuildContext context) {
    final EditDataPurchaseController controller = Get.put(EditDataPurchaseController(context: context));
