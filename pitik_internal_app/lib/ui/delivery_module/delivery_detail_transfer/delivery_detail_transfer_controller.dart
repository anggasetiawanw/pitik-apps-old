...
class DeliveryDetailTransferController extends GetxController {
  ...
  late ButtonFill doneSendButton = ButtonFill(
      controller: GetXCreator.putButtonFillController('doneSendButton'),
      label: 'Terkirim',
      onClick: () {
  ...
  EditField efRemark = EditField(
      controller: GetXCreator.putEditFieldController('efRemarkDeliveryTransfer'), label: 'Catatan', hint: 'Ketik disini', alertText: '', textUnit: '', maxInput: 500, inputType: TextInputType.multiline, height: 160, onTyping: (value, editField) {});
