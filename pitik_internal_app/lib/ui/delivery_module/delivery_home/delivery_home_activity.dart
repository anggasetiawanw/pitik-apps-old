          ...
          Expanded(
              child: Container(
                  ...
                  child: TabBarView(
                      controller: _tabController.controller,
                      children: [
                        Obx(() => controller.isLoadingSales.isTrue ? const Center(child: ProgressLoading() ) : controller.listSalesOrder.value.isEmpty ? Align(
                          ...
                          child: Column(
                              ...
                              Container(
                                  ...
                                  textAlign: TextAlign.center,
                                        ...
                                        return Column(
                                            children: [
                                                CardListDelivery(isPenjualan: true,
                                                    order: controller.listSalesOrder.value[index],
                                                    onTap: (){
                                                        Get.toNamed(RoutePage.deliveryDetailSO, arguments:controller.listSalesOrder.value[index], )!.then((value) {
                        ...
                        Obx(() => controller.isLoadingTransfer.isTrue ? const Center(child: ProgressLoading() ) : controller.listTransfer.value.isEmpty ? Align(
                          alignment: Alignment.center,
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                              ...
                              Container(
                                  ...
                                  textAlign: TextAlign.center,
                                        ...
                                        return Column(
                                            children: [
                                                CardListDelivery(isPenjualan: false,
                                                    transferModel: controller.listTransfer.value[index],
                                                    onTap: (){
                                                        Get.toNamed(RoutePage.deliveryDetailTransfer, arguments:controller.listTransfer.value[index], )!.then((value) {
