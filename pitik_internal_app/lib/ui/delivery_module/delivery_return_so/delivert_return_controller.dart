...
import 'package:pitik_internal_app/widget/sku_reject_so/sku_reject.dart';
class DeliveryRejectSOController extends GetxController {
    ...
    SpinnerField remarkField = SpinnerField(controller: GetXCreator.putSpinnerFieldController("remarksss"), label: "Alasan", hint: "Pilih Salah Satu", alertText: "", items: const {
    ...
    Order generatePayload(){
            ...
            if(skuReject.controller.selectedValue.value[index]){
                products.add(
                    Products(
                        ...
                        quantity: order.products![index]!.category!.name == AppStrings.LIVE_BIRD ||order.products![index]!.category!.name! == AppStrings.AYAM_UTUH ||order.products![index]!.category!.name! == AppStrings.BRANGKAS ? skuReject.controller.jumlahEkorDitolak.value[index].getInputNumber()!.toInt() : null,
        ...
        return Order(
            reason: remarkField.controller.textSelected.value,
