...
import '../../../widget/common/manufacture_status.dart';
import 'manufacture_detail_controller.dart';
...
class ManufactureDetailActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ManufactureDetailController controller = Get.put(ManufactureDetailController(context: context));
    Widget appBar() {
      return AppBar(
        elevation: 0,
        leading: IconButton(
              ...
              child: Row(
                ...
                children: [
                  controller.manufactureModel.status == 'INPUT_DRAFT'
                      ...
                      : controller.manufactureModel.status == 'INPUT_CONFIRMED'
                          ...
                          : controller.manufactureModel.status == 'INPUT_BOOKED'
                              ? Expanded(
                                  child: ButtonFill(
                                      controller: GetXCreator.putButtonFillController('createOutput'),
                                      label: 'Buat Output',
                                      onClick: () {
                              ...
                              : controller.manufactureModel.status == 'OUTPUT_DRAFT'
                                  ...
                                  : controller.manufactureModel.status == 'OUTPUT_CONFIRMED'
                                      ? Expanded(
                                          child: ButtonFill(
                                              controller: GetXCreator.putButtonFillController('cancelManufacture'),
                                              label: 'Batal',
                                              onClick: () {
                  ...
                  if (controller.manufactureModel.status == 'INPUT_DRAFT') ...[
                    ...
                    Expanded(
                        child: ButtonOutline(
                            controller: GetXCreator.putButtonOutlineController('cancelManufacture'),
                            label: 'Batal',
                            onClick: () {
                              _showBottomDialogCancel(context, controller);
                            }))
          ...
          children: [
            Row(
              ...
              children: [
                ...
                ManufactureStatus(manufactureStatus: controller.manufactureModel.status),
              ],
            ),
            const SizedBox(
              height: 16,
            ),
            infoDetailHeader('Sumber', controller.manufactureModel.operationUnit!.operationUnitName!),
          ],
        ),
      );
    }
    ...
    List<Widget> detailSku() {
      return [
        ...
        Container(
          ...
          child: Column(
            children: [
              infoDetailSKU('Kategori SKU', controller.manufactureModel.input!.name!),
              const SizedBox(
                height: 14,
              ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...detailSku(),
                            if (controller.manufactureModel.status == 'OUTPUT_DRAFT' || controller.manufactureModel.status == 'OUTPUT_CONFIRMED') ...[
                              Container(
                                margin: const EdgeInsets.symmetric(vertical: 16),
                                child: Text(
                                  'Detail Output',
  ...
  Future<void> _showBottomDialogCancel(BuildContext context, ManufactureDetailController controller) {
  ...
  Future<void> _showBottomDialogSend(BuildContext context, ManufactureDetailController controller) {
    return showModalBottomSheet(
        backgroundColor: Colors.transparent,
        context: context,
        isScrollControlled: true,
