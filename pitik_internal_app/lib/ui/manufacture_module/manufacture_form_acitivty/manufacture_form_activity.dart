...
class ManufactureFormActivity extends StatelessWidget {
const ManufactureFormActivity({super.key});

    @override
Widget build(BuildContext context) {
    final ManufactureFromController controller = Get.put(ManufactureFromController(context: context));
    Widget appBar() {
    return AppBar(
        elevation: 0,
        leading: IconButton(
            ...
            alignment: Alignment.bottomCenter,
                child: Container(
                    ...
                    child: Row(
                        ...
                        children: [
                            Expanded(child:ButtonFill(controller: GetXCreator.putButtonFillController("saveButton"), label: "Simpan", onClick: (){controller.createManufacture("INPUT_DRAFT");})),
    ...
    _showBottomDialog(BuildContext context, ManufactureFromController controller) {
