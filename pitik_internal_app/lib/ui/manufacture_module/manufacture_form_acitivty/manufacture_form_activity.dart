...
import 'manufacture_form_controller.dart';
...
class ManufactureFormActivity extends StatelessWidget {
              ...
              Expanded(
                  child: ButtonFill(
                      ...
                      onClick: () {
                        ...
                        controller.createManufacture('INPUT_DRAFT');
                      })),
              const SizedBox(
                width: 16,
              ),
  ...
  Future<void> _showBottomDialog(BuildContext context, ManufactureFromController controller) {
