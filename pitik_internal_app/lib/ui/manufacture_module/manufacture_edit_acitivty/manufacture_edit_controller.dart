...
class ManufactureEditFromController extends GetxController {
  ...
  late ButtonFill yesButton = ButtonFill(
      ...
      label: 'Ya',
      onClick: () {
        Constant.track('Click_Konfirmasi_Edit_Manufaktur');
        Get.back();
  ...
  late SpinnerField sourceField = SpinnerField(
      ...
      onSpinnerSelected: (value) {
        if (listOperationUnits.value.isNotEmpty) {
          final OperationUnitModel? selectUnit = listOperationUnits.value.firstWhereOrNull((element) => element!.operationUnitName! == value);
          if (selectUnit != null) {
  ...
  late SpinnerField categorySKUField = SpinnerField(
      ...
      onSpinnerSelected: (value) {
        ...
        if (categorySelect != null) {
          ...
          final Map<String, int> mapListAmount = {};
          final Map<String, double> mapListWeight = {};
  ...
  void countingAPI() {
    ...
    if (countApi == 2) {
      ...
      Constant.trackRenderTime('Manufacture_Edit_Form', totalTime);
    }
  }
  ...
  ManufactureModel generatePayload(String status) {
    if (manufactureModel.operationUnit!.operationUnitName != sourceField.controller.textSelected.value) {
      ...
      selectSource = listOperationUnits.value.firstWhereOrNull(
        (element) => element!.operationUnitName == sourceField.controller.textSelected.value,
      );
    ...
    if (manufactureModel.input!.productItems![0]!.name != skuField.controller.textSelected.value) {
      final StockModel? selectStock = categorySelect!.productItems!.firstWhereOrNull(
        (element) => element!.name == skuField.controller.textSelected.value,
      );
  ...
  bool validation() {
    ...
    if (categorySKUField.controller.textSelected.value.isEmpty) {
      ...
      return false;
    } else if (categorySKUField.controller.textSelected.value == 'Ceker' ||
        categorySKUField.controller.textSelected.value == 'Kepala' ||
        categorySKUField.controller.textSelected.value == 'Hati Ampela' ||
        categorySKUField.controller.textSelected.value == 'Karkas') {
