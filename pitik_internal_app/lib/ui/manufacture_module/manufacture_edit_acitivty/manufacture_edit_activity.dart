...
import 'manufacture_edit_controller.dart';
...
class ManufactureEditFormActivity extends StatelessWidget {
              ...
              : Stack(
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [controller.sourceField, controller.categorySKUField, controller.skuField, controller.amountField, controller.totalField],
                      ),
                    ),
                    bottomNavbar()
                  ],
  ...
  Future<void> _showBottomDialog(BuildContext context, ManufactureEditFromController controller) {
