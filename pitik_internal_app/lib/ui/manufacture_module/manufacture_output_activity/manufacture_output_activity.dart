...
import 'manufacture_output_controller.dart';
...
class ManufactureOutputActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ManufactureOutputController controller = Get.put(ManufactureOutputController(context: context));
    Widget appBar() {
      return AppBar(
        elevation: 0,
        leading: IconButton(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (controller.showSKUCard.isTrue) ...[controller.skuCard, controller.efTotalKG],
                            const SizedBox(
                              height: 100,
                            )
                          ],
  ...
  Future<dynamic> _showBottomDialog(BuildContext context, ManufactureOutputController controller) {
