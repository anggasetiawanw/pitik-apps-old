...
import '../../../widget/common/list_card_manufacture.dart';
import '../../../widget/common/loading.dart';
import 'manufacture_home_controller.dart';
...
class ManufactureHomeActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ManufactureHomeController controller = Get.put(ManufactureHomeController(context: context));
    Widget appBar() {
      return AppBar(
        elevation: 0,
        leading: IconButton(
                  ...
                  child: controller.listManufacture.value.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final int length = controller.listManufacture.value.length;
                            if (index >= length) {
                              return const Column(
                                children: [
