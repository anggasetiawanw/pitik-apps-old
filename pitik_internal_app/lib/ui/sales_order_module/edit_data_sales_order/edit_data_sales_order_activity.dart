...
import 'edit_data_sales_order_controller.dart';
...
class EditDataSalesOrder extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: ButtonFill(
                  controller: GetXCreator.putButtonFillController('saveEditDataSalesOrder'),
                  label: 'Simpan',
                  onClick: () {
                    controller.status.value = 'DRAFT';
                    controller.saveEditOrder();
                  },
                ),
              ),
              ...
              Expanded(
                child: ButtonOutline(
                  controller: GetXCreator.putButtonOutlineController('confirmEditDataSalesOrder'),
                  label: 'Konfirmasi',
                  onClick: () {
  ...
  Future<void> _showBottomDialog(BuildContext context, EditDataSalesOrderController controller) {
