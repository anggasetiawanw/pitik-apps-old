...
class StockHomeActivity extends GetView<StockHomeController> {
  ...
  Widget build(BuildContext context) {
    final StockHomeController controller = Get.put(StockHomeController(
      context: context,
    ));
    Widget appBar() {
      return AppBar(
    ...
    Widget listExpand(String tille, String text) {
      return Row(
        ...
        children: [
          ...
          Text(
            text,
            style: AppTextStyle.blackTextStyle.copyWith(fontWeight: FontWeight.w500, fontSize: 10),
          )
        ],
      );
    }
          ...
          Row(
            children: [
              Container(
                width: 22,
                height: 8,
                decoration: BoxDecoration(color: pieData.color, borderRadius: BorderRadius.circular(8)),
              ),
              const SizedBox(
                width: 8,
              ),
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Container(
                                ...
                                child: TabBarView(controller: controller.tabController.controller, children: [
                                  Column(
                                    children: [
                                      controller.sourceOpname,
                                      controller.isLoadingOpname.isTrue
                                          ? const Expanded(child: Align(alignment: Alignment.center, child: ProgressLoading()))
                                                    ...
                                                    child: RefreshIndicator(
                                                      ...
                                                      child: ListView.builder(
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          ...
                                                          return Column(
                                                            children: [
                                                              controller.listOpname.value[index]!.products!.isNotEmpty
                                                                  ? CardListStock(
                                                              ...
                                                              series: <ChartSeries<ChartData, String>>[
                                                                BarSeries<ChartData, String>(
                                                                  ...
                                                                  dataLabelSettings: DataLabelSettings(
                                                                      ...
                                                                      isVisible: true,
                                                                      textStyle: AppTextStyle.whiteTextStyle.copyWith(
                                                                        fontSize: 10,
