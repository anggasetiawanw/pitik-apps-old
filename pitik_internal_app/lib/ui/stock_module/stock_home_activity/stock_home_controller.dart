...
class StockHomeController extends GetxController {
    ...
    late ButtonFill stockOpnameButton = ButtonFill(controller: GetXCreator.putButtonFillController("stockOpname"), label: "Stock Opname", onClick: (){ Get.toNamed(RoutePage.stockOpname, arguments: [null,false,selectSourceOpname])!.then((value) {
