...
import '../../../widget/common/list_card_home.dart';
import '../../../widget/common/loading.dart';
import '../../../widget/common/search_field.dart';
...
class HomePageCustomer extends StatelessWidget {
                      ...
                      : Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final int length = controller.isSearch.isTrue ? controller.searchCustomer.value.length : controller.listCustomer.value.length;
                              if (index >= length) {
                                return const Column(
                                  children: [
                              ...
                              return Column(
                                children: [
                                  ...
                                  controller.isSearch.isTrue
                                      ? index == controller.searchCustomer.value.length - 1
                                          ? const SizedBox(height: 120)
                                          : const SizedBox()
                                      : index == controller.listCustomer.value.length - 1
                                          ? const SizedBox(height: 120)
                                          : const SizedBox(),
                                ],
                              );
  ...
  Future<void> _showBottomDialog(BuildContext context, HomePageCustomerController controller) {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text('Tentukan persona dari customer yang kamu kunjungi agar lebih mudah saat mengisi data?', style: TextStyle(color: Color(0xFF9E9D9D), fontSize: 12)),
                ),
                Container(
