...
import 'new_data_controller.dart';
...
class NewData extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final NewDataController controller = Get.put(NewDataController(context: context));
    Widget appBar() {
      return AppBar(
        elevation: 0,
        leading: IconButton(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: ButtonFill(
                            controller: GetXCreator.putButtonFillController('buttonBaru'),
                            label: 'Simpan',
                            onClick: () {
  ...
  Future<void> _showBottomDialog(BuildContext context, NewDataController controller) {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text('Pastikan jawaban yang kamu pilih sesuai dengan jawaban customer ya!', style: TextStyle(color: Color(0xFF9E9D9D), fontSize: 12)),
                ),
                Container(
