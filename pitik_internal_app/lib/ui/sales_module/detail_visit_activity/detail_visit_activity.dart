...
import 'detail_visit_controller.dart';
...
class DetailVisitCustomer extends GetView<DetailVisitController> {
  ...
  Widget build(BuildContext context) {
    final DetailVisitController controller = Get.put(DetailVisitController(context: context));
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  controller.salerPerson != null ? '${controller.salerPerson}' : '-',
                  style: AppTextStyle.blackTextStyle.copyWith(fontSize: 10),
                ),
              ],
            ),
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            isLeadStatus
                ? LeadStatus(leadStatus: controller.customer.value?.leadStatus)
                : Expanded(
                    flex: 2,
                    child: Text(
                      value,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        listDetail('Apakah ada issue terkait harga yang kita tawarkan?', controller.customer.value!.orderIssue! ? 'Ya' : 'Tidak', false),
                        controller.customer.value!.orderIssue!
                            ? listDetail('Jenis Kendala', controller.customer.value!.orderIssueCategories != null ? controller.customer.value!.orderIssueCategories!.map((e) => e!.title.toString()).reduce((a, b) => '$a , $b') : '-', false)
                            : const SizedBox(),
                        listDetail('Keterangan', controller.customer.value!.remarks != null ? Uri.decodeFull(controller.customer.value!.remarks!) : '-', false),
                        listDetail('Prospek Pembelian', controller.customer.value!.prospect != null ? '${controller.customer.value!.prospect}' : '-', false),
                        Container(
                        ...
                        controller.customer.value!.products != null ? Column(children: (controller.customer.value!.products as List<Products?>).map((Products? products) => customExpandalbe(products!)).toList()) : const SizedBox(),
                        const SizedBox(
                          height: 20,
                        ),
                      ],
