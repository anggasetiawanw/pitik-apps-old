...
import 'package:pitik_internal_app/widget/common/list_card_detail.dart';
...
class CustomerDetail extends GetView<CustomerDetailController> {
                ...
                children: [
                  ...
                  Text(
                    controller.customer.value!.latestVisit != null
                        ...
                        : "-",
                    style: AppTextStyle.blackTextStyle.copyWith(
                        fontWeight: AppTextStyle.medium, fontSize: 10),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
            ...
            isLeadStatus
                ...
                : Expanded(
                    ...
                    child: Text(
                      ...
                      style: AppTextStyle.blackTextStyle.copyWith(
                          fontWeight: AppTextStyle.medium, fontSize: 12),
                      overflow: TextOverflow.clip,
                    ),
                  ),
          ],
      ...
      return Container(
        ...
        child: Expandable(
            ...
            child: Column(
              children: [
                listDetail(
                    "Jenis Kebutuhan", products.category!.name!, false),
                listDetail("Ukuran",
                    "${products.value ?? "-"} ${products.uom ?? ""}", false),
                listDetail("Kebutuhan Kg/Hari",
                    "${products.dailyQuantity} Kg/Hari", false),
                listDetail(
                    "Harga /Kg ",
                    "${NumberFormat.currency(locale: 'id', symbol: "Rp ", decimalDigits: 2).format(products.price!)} /Kg",
                    false),
              ],
            )),
      );
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            listDetail(
                "Tipe Bisnis",
                controller.customerDetail.value!.businessType != null
                    ? "${controller.customerDetail.value!.businessType}"
                    : "-",
                false),
            listDetail(
                "Nama Pemilik",
                controller.customerDetail.value!.ownerName != null
                    ? "${controller.customerDetail.value!.ownerName}"
                    : "-",
                false),
            listDetail(
                "Nomor Telepon",
                controller.customerDetail.value!.phoneNumber != null
                    ? "${controller.customerDetail.value!.phoneNumber}"
                    : "-",
                false),
            listDetail(
                "PIC Sales",
                controller.customerDetail.value!.salesperson!.email != null
                    ? "${controller.customerDetail.value!.salesperson!.email}"
                    : "-",
                false),
            listDetail(
            ...
            listDetail(
                "Kota",
                controller.customerDetail.value!.city!.name != null
                    ? "${controller.customerDetail.value!.city!.name}"
                    : "-",
                false),
            listDetail(
                "Kecamatan",
                controller.customerDetail.value!.district!.name != null
                    ? "${controller.customerDetail.value!.district!.name}"
                    : "-",
                false),
            listDetail(
                "Supplier",
            ...
            listDetail(
                ...
                controller.customerDetail.value!.latestVisit != null &&
                        controller
                                .customerDetail.value!.latestVisit!.prospect !=
                            null
                    ? "${controller.customerDetail.value!.latestVisit!.prospect}"
                    : "-",
                false),
                                ...
                                : controller.visitCustomer.value.isEmpty
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemCount: controller.isLoadMore.isTrue
                                            ? controller.visitCustomer.value
                                                    .length +
                                                1
                                            : controller
                                                .visitCustomer.value.length,
  ...
  _showButtonDialog(BuildContext context, CustomerDetailController controller) {
    showDialog(
      context: context,
  ...
  _showBottomDialog(BuildContext context, CustomerDetailController controller) {
                    ...
                    () => controller.isLoadingDetails.isTrue
                        ...
                        : Text(
                            controller.customerDetail.value!.isArchived!
                                ...
                                : "Apakah Kamu yakin untuk mengarsipkan data ini?",
                            style: AppTextStyle.primaryTextStyle.copyWith(
                                fontSize: 21, fontWeight: AppTextStyle.bold),
                          ),
                  ),
                ),
                Container(
                    ...
                    () => controller.isLoadingDetails.isTrue
                        ...
                        : Text(
                            controller.customerDetail.value!.isArchived!
                                ...
                                : "Data yang kamu arsipkan tidak akan muncul di kolom pilihan nama bisnis pada form kunjungan",
                            style: const TextStyle(
                                color: Color(0xFF9E9D9D), fontSize: 12)),
                  ),
                ),
                Container(
