...
class CreateGrPurchaseJagal extends GetView<CreateGrPurchaseController>{
  const CreateGrPurchaseJagal({
    super.key
  });

  @override
  Widget build(BuildContext context) {
    CreateGrPurchaseJagalController controller = Get.put(CreateGrPurchaseJagalController(context: context));
                  ...
                  children: [
                    ...
                    Expanded(
                        child: ButtonFill(
                          ...
                          onClick: () {
                            controller.isValid() ?
                            showBottomDialog(context, controller) : null ;
                          },
                        )):
  ...
  showBottomDialog(BuildContext context, CreateGrPurchaseJagalController controller) {
