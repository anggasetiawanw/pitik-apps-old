...
import 'detail_gr_transfer_controller.dart';
...
class DetailGRTransfer extends StatelessWidget {
              ...
              child: Row(
                ...
                children: [
                  controller.transferModel.status == 'RECEIVED'
                      ? Expanded(
                          child: ButtonFill(
                              controller: GetXCreator.putButtonFillController('cancelTransferReceive'),
                              label: 'Batal',
                              onClick: () {
                      ...
                      : controller.transferModel.status == 'DELIVERED'
                          ? Expanded(
                              child: ButtonFill(
                                  controller: GetXCreator.putButtonFillController('createTransferReceive'),
                        ...
                        children: [
                          ...
                          if (controller.transferModel.products!.isNotEmpty && controller.transferModel.status == 'DELIVERED') ...[
                            ...
                            Container(
                              margin: const EdgeInsets.symmetric(vertical: 16),
                              child: Text(
                                controller.transferModel.status == 'DELIVERED' ? 'Detail SKU Transfer' : 'Detail SKU Penerimaan',
                                style: AppTextStyle.blackTextStyle.copyWith(fontWeight: FontWeight.w700),
                              ),
                            ),
                            Container(
  ...
  Future<void> _showBottomDialogCancel(BuildContext context, DetailGRTransferController controller) {
