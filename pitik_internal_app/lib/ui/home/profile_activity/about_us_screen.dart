...
class AboutUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const String misi = "Memberikan dukungan kepada peternak Indonesia untuk seluruh aktivitas produksi ayam, mulai dari penyediaan sapronak berkualitas, mendorong inovasi teknologi produksi, dan juga membantu penjualan hasil panen dengan skema yang lebih transparan dan harga yang lebih kompetitif";
    Widget appBar() {
      return AppBar(
        elevation: 0,
        leading: IconButton(
    ...
    Widget customExpandale(String title, String text){
        return Container(
            ...
            child: Expandable(controller: GetXCreator.putAccordionController(title), headerText: title, child:RichText(text: TextSpan(children: [
                ...
                margin: const EdgeInsets.symmetric(horizontal: 16),
                  child: Column(children: [
                    ...
                    Container(
                        ...
                        child: Text(text, style: AppTextStyle.blackTextStyle.copyWith(fontSize: 12),),
                    ),
