  ...
  Widget build(BuildContext context) {
    ...
    Widget customExpandale(String title, String text,String url){
        return Container(
            ...
            child: Expandable(controller: GetXCreator.putAccordionController(url), headerText: title, child: RichText(text: TextSpan(children: [
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                      ...
                      child: Text("Credit Penggunaan Aset Visual", style: AppTextStyle.primaryTextStyle.copyWith(fontSize: 16 , fontWeight: FontWeight.w500))),
