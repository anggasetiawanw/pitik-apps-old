...
class TerminateRejectedController extends GetxController {
  ...
  TerminateRejectedController({required this.context});
...
class TerminateRejectedBindings extends Bindings {
  BuildContext context;
  TerminateRejectedBindings({required this.context});
  @override
  void dependencies() {
    Get.lazyPut(() => TerminateRejectedController(context: context));
  }
}
