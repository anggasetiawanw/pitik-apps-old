...
class TerminateDetailController extends GetxController {
    ...
    late ButtonFill yesTerminateButton = ButtonFill(controller: GetXCreator.putButtonFillController("yesSendButton"), label: "Ya", onClick: (){
         Get.back();
        updateTerminate("FINISHED");
    });
    ButtonOutline noTerminateButton = ButtonOutline(controller: GetXCreator.putButtonOutlineController("NoSendButton"), label: "Tidak", onClick: (){
        Get.back();
    });

    late ButtonFill yesOrderStockButton = ButtonFill(controller: GetXCreator.putButtonFillController("yesSendButton"), label: "Ya", onClick: (){
         Get.back();
        updateTerminate("BOOKED");
    });
    ButtonOutline noOrderStockButton = ButtonOutline(controller: GetXCreator.putButtonOutlineController("NoSendButton"), label: "Tidak", onClick: (){
        Get.back();
    });
