...
class CardListHome extends StatelessWidget {
    ...
    const CardListHome({super.key, required this.customer, required this.onTap});
            ...
            child: Container(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        Text(
                          customer.latestVisit != null ? "${customer.salesperson!.email} - ${dateCustomer!.day} ${dateCustomer.month} ${dateCustomer.year} - ${dateCustomer.hour}:${dateCustomer.minute}" : "-",
