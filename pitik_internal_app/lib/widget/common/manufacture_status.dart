...
class ManufactureStatus extends StatelessWidget {
  const ManufactureStatus({required this.manufactureStatus, super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: manufactureStatus == null
              ? AppColors.grey
              : manufactureStatus == 'INPUT_DRAFT'
                  ? const Color(0xFFFEEFD2)
                  : manufactureStatus == 'INPUT_CONFIRMED'
                      ? const Color(0xFFD0F5FD)
                      : manufactureStatus == 'INPUT_BOOKED'
                          ? const Color(0xFFFAEDCF)
                          : manufactureStatus == 'OUTPUT_DRAFT'
                              ? const Color(0xFFFEF6D2)
                              : manufactureStatus == 'OUTPUT_CONFIRMED'
                                  ? const Color(0xFFD0F5FD)
                ...
                : manufactureStatus == 'INPUT_CONFIRMED'
                    ...
                    : manufactureStatus == 'INPUT_BOOKED'
                        ...
                        : manufactureStatus == 'OUTPUT_DRAFT'
                            ? 'Output Draft'
                            : manufactureStatus == 'OUTPUT_CONFIRMED'
                                ? 'Output Terkonfirmasi'
                                : 'Dibatalkan',
        style: manufactureStatus == null
