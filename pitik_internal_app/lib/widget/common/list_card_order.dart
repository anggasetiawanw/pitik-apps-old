                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      OrderStatus(orderStatus: order.status,returnStatus: order.returnStatus,grStatus: order.grStatus,soPage: isSoPage,),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          "Kategori : ", style: AppTextStyle.subTextStyle.copyWith(fontSize: 12),
                          overflow: TextOverflow.clip),
                      Text(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          ...
                          overflow: TextOverflow.clip),
                      Text(
                        order.products!.isEmpty ? "-" : order.products!.map((e) => e!.category!.name.toString()).reduce((a, b) =>'$a , $b'),
                        style: AppTextStyle.blackTextStyle.copyWith(fontSize: 12),
                        overflow: TextOverflow.ellipsis,
                      ),
                    ],
