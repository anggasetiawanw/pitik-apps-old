            ...
            child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "${purchase.vendor == null ? purchase.jagal == null ? "-" : purchase.jagal!.operationUnitName!
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          "Jenis Sumber : ", style: AppTextStyle.subTextStyle.copyWith(fontSize: 12),
                          overflow: TextOverflow.clip),
                      Text(
                        purchase.vendor != null  ? "Vendor" : purchase.jagal != null ? "Jagal Eksternal" :"",
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          "Tujuan : ", style: AppTextStyle.subTextStyle.copyWith(fontSize: 12),
                          overflow: TextOverflow.clip),
                      Text(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          "SKU : ", style: AppTextStyle.subTextStyle.copyWith(fontSize: 12),
                          overflow: TextOverflow.clip),
                      Expanded(child:
                      Text(
                        purchase.products!.isEmpty? "-": purchase.products!.length > 1 ? "${purchase.products![0]!.name} dan ${purchase.products!.length -1 } lainnya" : "${purchase.products![0]!.name}",
                  ...
                  const SizedBox(height: 16,),
                  Text(
                    "${purchase.modifiedDate!.isEmpty  ? "-" : purchase.modifiedBy!}" "${" - "}" "(${modifiedDate.day} ${DateFormat.MMM().format(modifiedDate)} ${modifiedDate.year})",
