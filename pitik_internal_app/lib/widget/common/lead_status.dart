...
import 'package:pitik_internal_app/utils/enum/lead_status.dart';


class LeadStatus extends StatelessWidget {
    const LeadStatus({super.key, required this.leadStatus});
    ...
    Widget build(BuildContext context) {
        ...
        return Container(
            ...
            child: Center(
                child: Text(leadStatus ?? LeadStatusEnum.na,
                style: textStyle,
                )
            ),
        );
