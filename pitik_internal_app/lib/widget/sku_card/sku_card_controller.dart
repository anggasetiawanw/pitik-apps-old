...
class SkuCardController extends GetxController {
  ...
  void addCard() {
    ...
    spinnerSize.value.add(
      SpinnerField(controller: GetXCreator.putSpinnerFieldController('size${idx}SKU'), label: 'SKU*', hint: 'Pilih Salah Satu', alertText: 'Ukuran harus dipilih!', items: const {}, onSpinnerSelected: (value) {}),
    );
    ...
    editFieldJenis.value.add(EditField(
        controller: GetXCreator.putEditFieldController('editJenis${idx}Sku'),
    ...
    editFieldHarga.value.add(EditField(
        controller: GetXCreator.putEditFieldController('editharga${idx}Sku'),
        ...
        listener: ResponseListener(
            onResponseDone: (code, message, body, id, packet) {
              if ((body as ProductListResponse).data[0]!.uom.runtimeType != Null) {
                listProduct.value.update(idx, (value) => body.data, ifAbsent: () => body.data);
