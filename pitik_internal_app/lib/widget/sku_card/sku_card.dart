...
import 'sku_card_controller.dart';

/// @author [Angga Setiawan Wahyudin]
/// @email [angga.setiawan@pitik.id]
/// @create date 2023-02-13 14:00:16
/// @modify date 2023-02-13 14:00:16
/// @desc [description]

class SkuCard extends StatelessWidget {
  final SkuCardController controller;
  const SkuCard({required this.controller, super.key});
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          controller.spinnerProduct.value[index],
                          Obx(
                            () => controller.isLoadApi.isTrue ? controller.spinnerSize.value[index] : controller.spinnerSize.value[index],
                          ),
                          controller.editFieldJenis.value[index],
  ...
  Future<dynamic> _showBottomDialog(BuildContext context, int index, SkuCardController controller) {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin: const EdgeInsets.only(top: 24),
                  child: SvgPicture.asset('images/delete_sku.svg'),
                ),
                Container(
