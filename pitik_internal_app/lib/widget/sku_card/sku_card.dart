...
class SkuCard extends StatelessWidget {
    ...
    const SkuCard({super.key, required this.controller});
                                        ...
                                        decoration: const BoxDecoration(
                                          ...
                                          child: Column(
                                              children: [
                                                  ...
                                                  Obx(() => controller.isLoadApi.isTrue ? controller.spinnerSize.value[index] : controller.spinnerSize.value[index],),
    ...
    _showBottomDialog(BuildContext context, int index, SkuCardController controller) {
