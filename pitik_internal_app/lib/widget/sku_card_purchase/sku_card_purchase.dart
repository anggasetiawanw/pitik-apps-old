...
import 'sku_card_purchase_controller.dart';

class SkuCardPurchase extends StatelessWidget {
  final SkuCardPurchaseController controller;
  const SkuCardPurchase({required this.controller, super.key});
  ...
  Future<void> _showBottomDialog(BuildContext context, int index, SkuCardPurchaseController controller) {
