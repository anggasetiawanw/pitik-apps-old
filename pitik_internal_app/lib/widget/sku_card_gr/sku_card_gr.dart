...
import 'sku_card_gr_controller.dart';
...
class SkuCardGr extends StatelessWidget {
  ...
  const SkuCardGr({required this.controller, super.key});
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  controller.products[index]!.returnQuantity != null
                      ? controller.products[index]!.returnQuantity != 0
                          ? infoDetailSKU('Jumlah Ekor', '${controller.products[index]!.returnQuantity} Ekor')
                          : const SizedBox()
                      : controller.products[index]!.quantity != null && controller.products[index]!.quantity != 0
                          ? infoDetailSKU('Jumlah Ekor', '${controller.products[index]!.quantity} Ekor')
                          : const SizedBox(),
                  ...
                  controller.products[index]!.returnWeight != null
                      ? controller.products[index]!.returnWeight != 0
                          ? infoDetailSKU('Kebutuhan', '${controller.products[index]!.returnWeight} Kg')
                          : const SizedBox()
                      : controller.products[index]!.weight != null && controller.products[index]!.weight != 0
                  ...
                  controller.products[index]!.category!.name == AppStrings.AYAM_UTUH || controller.products[index]!.category!.name == AppStrings.BRANGKAS || controller.products[index]!.category!.name == AppStrings.LIVE_BIRD
                      ? controller.efSumChickReceived.value[index]
                      : const SizedBox(),
