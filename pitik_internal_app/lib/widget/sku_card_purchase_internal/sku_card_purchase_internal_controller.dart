    ...
    addCard() {
        ...
        editFieldJumlahAyam.value.add(EditField(
            controller: GetXCreator.putEditFieldController(
                "editJumlah${numberList}SKUInternal"),
            label: "Jumlah Ekor",
            hint: "Ketik di sini",
        ...
        editFieldKebutuhan.value.add(EditField(
            controller: GetXCreator.putEditFieldController(
                "editJenis${numberList}SKUInternal"),
        ...
        editFieldHarga.value.add(EditField(
            controller: GetXCreator.putEditFieldController(
                "editharga${numberList}SKUInternal"),
            label: "Harga",
            hint: "Ketik di sini",
            alertText: "Kolom Ini Harus Di Isi",
            textUnit: "/Kg",
...
class SkuCardPurchaseInternalBinding extends Bindings {
    ...
    @override
    void dependencies() {
        Get.lazyPut<SkuCardPurchaseInternalController>(() =>
            SkuCardPurchaseInternalController(tag: tag, context: context));
    }
}