...
import 'sku_card_purchase_internal_controller.dart';

class SkuCardPurchaseInternal extends StatelessWidget {
  final SkuCardPurchaseInternalController controller;
  const SkuCardPurchaseInternal({required this.controller, super.key});
  ...
  Future<void> _showBottomDialog(BuildContext context, int index, SkuCardPurchaseInternalController controller) {
