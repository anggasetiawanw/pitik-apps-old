...
class SkuCardPurchaseInternal extends StatelessWidget {
  ...
  const SkuCardPurchaseInternal({super.key, required this.controller});
  ...
  _showBottomDialog(BuildContext context, int index, SkuCardPurchaseInternalController controller) {
