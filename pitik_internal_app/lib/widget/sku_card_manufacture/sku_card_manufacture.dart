...
import 'sku_card_manufacture_controller.dart';

class SkuCardManufacture extends StatelessWidget {
  final SkuCardManufactureController controller;
  const SkuCardManufacture({required this.controller, super.key});
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(margin: const EdgeInsets.symmetric(horizontal: 16), child: Text('Output ${index + 1}')),
                          GestureDetector(
                              onTap: () {
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          controller.spinnerSku.value[index],
                          controller.editFieldJumlahAyam.value[index],
                          controller.editFieldJumlahKg.value[index],
  ...
  Future<dynamic> _showBottomDialog(BuildContext context, int index, SkuCardManufactureController controller) {
