...
class SkuCardManufacture extends StatelessWidget {
  ...
  const SkuCardManufacture({super.key, required this.controller});
  ...
  _showBottomDialog(BuildContext context, int index, SkuCardManufactureController controller) {
