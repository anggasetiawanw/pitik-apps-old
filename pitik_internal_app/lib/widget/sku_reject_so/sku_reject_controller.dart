  ...
  void addCard() {
    for (var _ in products) {
      ...
      jumlahEkorDitolak.value.add(EditField(
          controller: GetXCreator.putEditFieldController('jumlahEkorDitolak${numberList}Sku'),
      ...
      jumlahKgDitolak.value.add(EditField(
          controller: GetXCreator.putEditFieldController('jumlahKgDitolak${numberList}Sku'),
