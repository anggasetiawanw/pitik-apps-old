...
class SkuCardRemark extends StatelessWidget {
  ...
  const SkuCardRemark({super.key, required this.controller});
  ...
  _showBottomDialog(BuildContext context, int index, SkuCardRemarkController controller) {
