...
import 'sku_card_remark_controller.dart';

class SkuCardRemark extends StatelessWidget {
  final SkuCardRemarkController controller;
  const SkuCardRemark({required this.controller, super.key});
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(margin: const EdgeInsets.symmetric(horizontal: 16), child: Text('Catatan ${index + 1}')),
                          GestureDetector(
                              onTap: () {
  ...
  Future<void> _showBottomDialog(BuildContext context, int index, SkuCardRemarkController controller) {
