...
class SkuCardRemarkController extends GetxController {
  ...
  void addCard() {
    ...
    editFieldJumlahAyam.value.add(EditField(
        controller: GetXCreator.putEditFieldController('editJumlah${numberList}Remark'),
        label: 'Jumlah Ekor',
        hint: 'Ketik di sini',
    ...
    editFieldPotongan.value.add(EditField(
        controller: GetXCreator.putEditFieldController('editPotongan${numberList}Remark'),
        label: 'Potongan',
        hint: 'Ketik di sini',
        alertText: 'Kolom Ini Harus Di Isi',
        textUnit: 'Potongan',
  ...
  List<dynamic> validation() {
    ...
    for (int i = 0; i < index.value.length; i++) {
      ...
      if (spinnerCategories.value[whichItem].controller.textSelected.value == AppStrings.AYAM_UTUH ||
          ...
          spinnerCategories.value[whichItem].controller.textSelected.value == AppStrings.LIVE_BIRD) {
