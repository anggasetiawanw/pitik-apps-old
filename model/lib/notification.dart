...
class Notifications extends BaseEntity {
  ...
  Notifications(
      {this.id, this.userId, this.subjectId, this.notificationType, this.headline, this.subHeadline, this.icon, this.iconPath, this.isRead = false, this.createdDate, this.modifiedDate, this.target, this.peripheralId, this.additionalParameters});
