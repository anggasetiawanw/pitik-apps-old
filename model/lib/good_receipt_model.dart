...
class GoodReceipt {
  ...
  static GoodReceipt toResponseModel(Map<String, dynamic> map) {
    return GoodReceipt(receivedDate: map['receivedDate'], remarks: map['remarks'], details: Mapper.children<Product>(map['details']), photos: Mapper.children<MediaUploadModel>(map['photos']));
  }
}
