...
class StockModel {
    ...
    StockModel({this.id, this.category, this.availableQuantity, this.availableWeight, this.reservedQuantity, this.reservedWeight, this.totalQuantity, this.totalWeight, this.productCategoryId, this.name, this.productCategoryName, this.productItemId,this.productItems});
