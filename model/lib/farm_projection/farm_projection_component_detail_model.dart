...
class FarmProjectionComponentDetail {
    ...
    static FarmProjectionComponentDetail toResponseModel(Map<String, dynamic> map) {
        return FarmProjectionComponentDetail(
            dayNum: map['dayNum'],
            current: map['current'] != null ? map['current'].toDouble() : map['current'],
            benchmark: map['benchmark'] != null ? map['benchmark'].toDouble() : map['benchmark']
        );
    }
}