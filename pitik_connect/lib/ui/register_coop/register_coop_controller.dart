...
class RegisterCoopController extends GetxController {
  ...
  void onInit() {
    ...
    Map<String, bool> mapList = {"Open House": false, "Semi House": false, "Closed House": false};
    Map<String, bool> mapListStatus = {"Aktif": false, "Non Aktif": false};
  ...
  void modifyInfrastructure() {
    ...
    if (ret[0]) {
      ...
      isLoading.value = true;
      try {
        Coop payload = modifyType.value == MODIFY_COOP ? generatePayloadModifyCoop() : generatePayloadModifyFloor();
        Service.push(
