...
class GrowthSetupController extends GetxController {
  ...
  void getDetailGrowthDay() {
    ...
    Service.push(
        ...
        context: context,
        body: [GlobalVar.auth!.token, GlobalVar.auth!.id, GlobalVar.xAppId!, ListApi.pathDeviceData('v2/b2b/iot-devices/smart-controller/coop/', 'growth-day', device.deviceSummary!.coopCodeId!, device.deviceSummary!.deviceId!)],
