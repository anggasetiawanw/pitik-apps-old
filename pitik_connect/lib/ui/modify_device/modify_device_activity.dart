        ...
        Widget appBar() {
            return AppBar(
                ...
                title: Text(
                    ...
                    "Edit ${controller.deviceType.value}" : "Ubah Nama ${controller.deviceType.value}",
                        ...
                        child: Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                    const SizedBox(
                                        height: 20,),
                                    controller.efDeviceName,
                                    controller.efDeviceType,
                                    controller.efCoop,
                                    controller.efFloor,
                                    controller.efMacAddress,
                                    controller.spDeviceStatus,
                                    const SizedBox(
                                        height: 18,
                                    ),
                        ...
                        children: [
                            ...
                            Container(
                                ...
                                child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                        Expanded(child: controller.bfYesModify),
                                        const SizedBox(
                                            width: 16,
                                        ),
                                        Expanded(
                                            child: controller.boNoModify,
                                        ),
                                    ],
                                ),
                            ),
