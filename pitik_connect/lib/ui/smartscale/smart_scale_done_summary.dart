                    ...
                    children: [
                        ListView(
                            ...
                            children: [
                                ...
                                Text(
                                    "Timbang ayam telah selesai, berikut adalah rangkumannya",
                                    textAlign: TextAlign.center,
                                    style: GlobalVar.whiteTextStyle.copyWith(fontSize: 16, fontWeight: GlobalVar.bold, color: GlobalVar.primaryOrange)
                                ),
                                            ...
                                            children: [
                                                ...
                                                Row(
                                                    ...
                                                    children: [
                                                        ...
                                                        Text(
                                                            "${Convert.getYear(startWeighingTime)}/${Convert.getMonthNumber(startWeighingTime)}/${Convert.getDay(startWeighingTime)} - ${Convert.getHour(startWeighingTime)}.${Convert.getMinute(startWeighingTime)}",
                                                ...
                                                Row(
                                                    ...
                                                    children: [
                                                        ...
                                                        Text(
                                                            "${Convert.getYear(endWeighingTime)}/${Convert.getMonthNumber(endWeighingTime)}/${Convert.getDay(endWeighingTime)} - ${Convert.getHour(endWeighingTime)}.${Convert.getMinute(endWeighingTime)}",
                                                            style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)
                                                        ),
                                                    ],
                                                ),
                                                ...
                                                Row(
                                                    ...
                                                    children: [
                                                        ...
                                                        Text(
                                                            "${_getTonase().toStringAsFixed(2)} kg",
                                                            style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)
                                                        ),
                                                    ],
                                                ),
                                                ...
                                                Row(
                                                    ...
                                                    children: [
                                                        ...
                                                        Text(
                                                            "${_getAverageWeight().toStringAsFixed(2)} kg",
                                                            style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)
                                                        ),
                                                    ],
                                                ),
