                  ...
                  : Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [Expanded(child: controller.totalWeighingField), const SizedBox(width: 8), Expanded(child: controller.outstandingTotalWeighingField)],
                          ),
                          Padding(
                          ...
                          Expanded(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(child: Column(children: controller.smartScaleDataWidget.entries.map((entry) => entry.value).toList()))
                              ],
                            ),
