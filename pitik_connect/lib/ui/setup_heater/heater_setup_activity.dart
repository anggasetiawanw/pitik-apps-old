...
class HeaterSetup extends GetView<HeaterSetupController> {
  const HeaterSetup({super.key});

  @override
  Widget build(BuildContext context) {
    final HeaterSetupController controller = Get.put(HeaterSetupController(context: context));
  ...
  Future showBottomDialog(BuildContext context, HeaterSetupController controller) {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Expanded(child: controller.bfYesSetHeater),
                      const SizedBox(
                        width: 16,
                      ),
                      Expanded(
                        child: controller.boNoSetHeater,
                      ),
                    ],
                  ),
                ),
