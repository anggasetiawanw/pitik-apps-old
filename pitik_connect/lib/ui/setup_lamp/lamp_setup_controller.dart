...
class LampSetupController extends GetxController {
  ...
  DeviceSetting generatePayloadLampSetup() {
    return DeviceSetting(id: lamp.id, deviceId: controllerData.deviceId, timeOnLight: dtfLampOn.getLastTimeSelectedText(), timeOffLight: dtfLampOff.getLastTimeSelectedText());
  }
