        ...
        child: SfCartesianChart(
            ...
            trackballBehavior: TrackballBehavior(
                ...
                builder: (context, trackballDetails) {
                  ...
                  return Wrap(
                    children: [
                      Container(
                        decoration: BoxDecoration(color: controller.backgroundCurrentTooltip.value, borderRadius: const BorderRadius.all(Radius.circular(8))),
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(color: controller.textColorCurrentTooltip.value, fontSize: 12, fontWeight: FontWeight.bold),
                            ),
                            Text(
                              'Max',
                              style: TextStyle(color: controller.textColorMaxTooltip.value, fontSize: 10),
                            ),
                            Text(
                              '${controller.selectedMax.value}  ${controller.uom}',
                              style: TextStyle(color: controller.textColorMaxTooltip.value, fontSize: 12, fontWeight: FontWeight.bold),
                            ),
                            Text(
                              'Min',
                              style: TextStyle(color: controller.textColorMinTooltip.value, fontSize: 10),
                            ),
                            Text(
                              '${controller.selectedMin.value}  ${controller.uom}',
                              style: TextStyle(color: controller.textColorMinTooltip.value, fontSize: 12, fontWeight: FontWeight.bold),
                            ),
                            Text(
            ...
            primaryXAxis: NumericAxis(
              ...
              axisLabelFormatter: (AxisLabelRenderDetails args) {
                TextStyle textStyle = const TextStyle(fontFamily: 'Montserrat', fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, fontSize: 12);
            ...
            series: <ChartSeries<GraphLine, double?>>[
              ...
              SplineRangeAreaSeries<GraphLine, double?>(
                  ...
                  lowValueMapper: (GraphLine point, _) => controller.backgroundMax.value != Colors.transparent && controller.showLineMin.isFalse
                      ? 0
                      : point.benchmarkMin == null || controller.showLineMin.isFalse
                          ? point.benchmarkMax
                          : point.benchmarkMin,
