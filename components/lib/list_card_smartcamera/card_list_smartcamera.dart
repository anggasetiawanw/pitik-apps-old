                    ...
                    child: Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Container(
                              ...
                              child: Row(children: [
                                Text("Total Kamera : ", style: GlobalVar.greyTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 10)),
                                Text("${device!.sensorCount!}", style: GlobalVar.blackTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 10))
                              ]))
                        ])))
              ]))
            ])));
