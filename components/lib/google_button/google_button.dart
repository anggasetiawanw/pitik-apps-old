    ...
    Widget build(BuildContext context) {
        ...
        return SizedBox(
            ...
            child: ElevatedButton(
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: const BorderSide(width: 2, color: GlobalVar.gray))),
                child: Container(
                    margin: const EdgeInsets.symmetric(vertical: 12),
                    child: Row(
                        children: [
                            SvgPicture.asset('images/google_icon.svg', width: 64, height: 64),
                            Text("Login with Google", textAlign: TextAlign.center, style: TextStyle(color: GlobalVar.black, fontSize: 14, fontWeight: GlobalVar.medium))
                        ]
                    )
                )
            )
