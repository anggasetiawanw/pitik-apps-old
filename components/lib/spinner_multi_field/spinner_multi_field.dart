                                ...
                                children: <Widget>[
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                color: controller.activeField.isTrue && controller.showTooltip.isFalse && controller.selectedValue.value.isNotEmpty ? GlobalVar.primaryOrange
                                                        : controller.activeField.isTrue && controller.showTooltip.isTrue ? GlobalVar.red
                                                        : Colors.transparent,
                                                width: 2
                                            )
                                        ),
                                                ...
                                                children: [
                                                    Expanded(
                                                        ...
                                                        child: DropdownButton(
                                                            ...
                                                            items: controller.items.value.map((key) => DropdownMenuItem<String>(
                                                                value: key,
                                                                onTap: () {
                                                            ...
                                                            hint: Text(
                                                                ...
                                                                ? controller.selectedValue.value.map((e) => e.toString()).reduce((a, b) =>'$a , $b')
                                                                : hint,
                                                                style: TextStyle(
                                                                    color: controller.selectedValue.value.isNotEmpty ? GlobalVar.black : const Color(0xFF9E9D9D),
                                                                    fontSize: 14
                                                                )
                                                            ),
                                            ...
                                            ? Container(
                                                ...
                                                child: Row(
                                                    children: [
                                                        ...
                                                        Text(
                                                            controller.alertText.value.isNotEmpty
                                                            ? controller.alertText.value
                                                            : alertText,
