...
class Expandable extends StatelessWidget {
    ...
    Expandable({super.key, required this.controller, required this.headerText, this.expanded = false, required this.child, this.titleWidget, this.titleBackgroundColorExpand =  const Color(0xFFFDDAA5), this.titleBackgroundColorCollapse =  const Color(0xFFFDDAA5), this.titleBorderColor = const Color(0xFFFDDAA5)});
    ...
    Widget build(BuildContext context) {
        ...
        return Obx(() =>
            GFAccordion(
                ...
                titleBorder: Border.all(color: titleBorderColor,),
