                ...
                InkWell(
                    ...
                    child: Container(
                        ...
                        child: Row(
                            ...
                            children: <Widget>[
                                Expanded(child: widget.title != null ? Text(widget.title!, style: widget.textStyle) : (widget.titleChild ?? Container())),
                                showAccordion ? widget.expandedIcon : widget.collapsedIcon
                            ]
                        )
                    )
                ),
                showAccordion ? Container(
                    decoration: BoxDecoration(
                    ...
                    child: SlideTransition(
                        position: offset,
                        child: widget.content != null ? Text(widget.content!) : (widget.contentChild ?? Container())
                    )
                ) : Container()
            ]
        )
