                        ...
                        child: Row(children: [
                          Expanded(
                              ...
                              child: Padding(
                                  ...
                                  child: Text(controller.textSeleted.value == "" ? hint : controller.textSeleted.value,
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          color: controller.activeField.isTrue
                                              ? controller.textSeleted.value == ""
                                                  ? const Color(0xFF9E9D9D)
                                                  : GlobalVar.black
                                              : GlobalVar.black,
                                          fontSize: 14)))),
                          Expanded(flex: 1, child: SvgPicture.asset(controller.activeField.isTrue ? "images/hour_glass_icon.svg" : "images/hour_glass_disable_icon.svg"))
                        ]))),
                Align(
