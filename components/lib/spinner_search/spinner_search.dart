                                        ...
                                        icon: Align(
                                            ...
                                            child : Row(
                                                children: [
                                                    ...
                                                    SvgPicture.asset("images/arrow_disable.svg"), const SizedBox(width: 16)
                                                ]
                                            )
                                        )
                                    ),
                                                ...
                                                decoration: InputDecoration(
                                                    ...
                                                    focusedBorder: OutlineInputBorder(
                                                        ...
                                                        borderSide: BorderSide(
                                                            color: controller.activeField.isTrue && controller.showTooltip.isFalse ? GlobalVar.primaryOrange : controller.activeField.isTrue && controller.showTooltip.isTrue ? GlobalVar.red : GlobalVar.outlineColor,
                                                            width: 2.0,
                                                        )
                                                    ),
