...
class ItemHistoricalSmartCameraController extends GetxController {
    ...
    SpinnerField spCrowdedness = SpinnerField(controller: GetXCreator.putSpinnerFieldController('spCameraIsCrowdedness'), label: 'Apakah ayam berkerumun?', hint: 'N/A', alertText: 'Harus diisi..!',
        items: const {'Ya': false, 'Tidak': false}, onSpinnerSelected: (text) {}
    );

    EditAreaField eaCrowdedness = EditAreaField(controller: GetXCreator.putEditAreaFieldController('spCameraCrowdednessRemarks'), label: 'Keterangan Penolakan', hint: 'Tulis keterangan penolakan', alertText: 'Harus diisi..!', maxInput: 300,
        onTyping: (text, field) {}
    );
