  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(border: Border.all(width: isRedChild ? 0 : 1.4, color: GlobalVar.outlineColor), borderRadius: BorderRadius.circular(8), color: isRedChild ? GlobalVar.redBackground : Colors.transparent),
                ...
                Expanded(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("${Convert.getYear(date)}-${Convert.getMonthNumber(date)}-${Convert.getDay(date)}",
                          style: GlobalVar.blackTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 10, overflow: TextOverflow.clip, color: GlobalVar.grayText)),
                    ],
                  ),
                  const SizedBox(height: 6),
                  smartScale.totalCount == null || smartScale.totalCount == 0
                      ? Text("Belum ada data timbang!", style: GlobalVar.blackTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 12, overflow: TextOverflow.clip, color: isRedChild ? GlobalVar.red : GlobalVar.black))
