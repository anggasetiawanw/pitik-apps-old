...
class EditAreaField extends StatelessWidget {
  ...
  EditAreaField(
      ...
      this.label,
      this.labelColor,
      this.textColor = GlobalVar.black,
      this.background = GlobalVar.primaryLight,
      this.prefixIcon,
      required this.hint,
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: Padding(
                            ...
                            child: Text(textUnit, style: TextStyle(color: controller.activeField.isTrue ? GlobalVar.primaryOrange : GlobalVar.black, fontSize: 12)),
                          ),
