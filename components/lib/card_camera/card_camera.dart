...
class CardCamera extends StatelessWidget {
    ...
    CardCamera({super.key, required this.controller});
                    ...
                    child: Column(
                        ...
                        children: [
                            ...
                            Container(
                                ...
                                child: const Text(
                                    "Data Kamera yang kamu hapus akan hilang secara permanen pastikan kembali sebelum menghapus",
