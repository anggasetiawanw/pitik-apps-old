...
import 'card_floor_controller.dart';
...
class CardFloor extends StatelessWidget {
  final CardFloorController controller;
  const CardFloor({super.key, required this.controller});
                ...
                child: Column(children: [
                  Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Container(margin: const EdgeInsets.symmetric(horizontal: 16), child: Text("Lantai ${index + 1}")),
                        GestureDetector(
                            onTap: () {
                  ...
                  Container(
                      ...
                      child: Column(children: [
                        controller.efFloorName.value[index],
                        index == (controller.index.value[controller.itemCount.value - 1]) && controller.itemCount.value != 1
                            ? ButtonOutline(controller: GetXCreator.putButtonOutlineController("Cancel$index"), label: "Cancel", onClick: () => _showBottomDialog(context, index, controller))
                            : Container(),
  ...
  _showBottomDialog(BuildContext context, int index, CardFloorController controller) {
          ...
          return Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Apakah kamu yakin ingin menghapus data lantai?",
                    style: GlobalVar.primaryTextStyle.copyWith(fontSize: 21, fontWeight: GlobalVar.bold),
                  ),
                ),
                Container(
                  margin: const EdgeInsets.only(top: 8, left: 16, right: 52),
                  child: const Text("Data lantai yang kamu hapus akan hilang secara permanen pastikan kembali sebelum menghapus", style: TextStyle(color: Color(0xFF9E9D9D), fontSize: 12)),
                ),
                Container(
                  margin: const EdgeInsets.only(top: 24),
                ...
                Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Expanded(
                          child: ButtonFill(
                              controller: GetXCreator.putButtonFillController("iyatambahLantai$index"),
                              label: "Ya",
                              onClick: () {
                      ...
                      Expanded(child: ButtonOutline(controller: GetXCreator.putButtonOutlineController("tidaktambahLantai$index"), label: "Tidak", onClick: () => Get.back()))
                    ])),
