...
import 'card_sensor_controller.dart';
...
class CardSensor extends StatelessWidget {
  ...
  const CardSensor({super.key, required this.controller});
                ...
                child: Column(children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(margin: const EdgeInsets.symmetric(horizontal: 16), child: Text("Sensor ${index + 1}")),
                        GestureDetector(
                            onTap: () {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text("Data sensor yang kamu hapus akan hilang secara permanen pastikan kembali sebelum menghapus", style: TextStyle(color: Color(0xFF9E9D9D), fontSize: 12)),
                ),
                Container(
                  margin: const EdgeInsets.only(top: 24),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(child: ButtonOutline(controller: GetXCreator.putButtonOutlineController("tidakVisit$index"), label: "Tidak", onClick: () => Get.back())),
                    ],
                  ),
                ),
