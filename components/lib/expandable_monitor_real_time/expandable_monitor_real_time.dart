  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => GFAccordion(
        ...
        contentBorder: const Border(
            bottom: BorderSide(color: GlobalVar.outlineColor, width: 1), left: BorderSide(color: GlobalVar.outlineColor, width: 1), right: BorderSide(color: GlobalVar.outlineColor, width: 1), top: BorderSide(color: GlobalVar.outlineColor, width: 1)),
        ...
        contentChild: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            sensorType == "temperature" || sensorType == "relativeHumidity"
                ? GestureDetector(
          ...
          Padding(
            ...
            child: GridView(
              ...
              children: List.generate(controller.sensorPositionList.length, (index) {
                return Row(
                  children: [
                    Container(width: 2, height: 2, decoration: const BoxDecoration(color: GlobalVar.black, shape: BoxShape.circle)),
                    const SizedBox(width: 4),
                    Text(controller.sensorPositionList[index] == null || controller.sensorPositionList[index]!.position == null ? '-' : controller.sensorPositionList[index]!.position!,
          ...
          controller.isLoading.isTrue ? const Center(child: SizedBox(height: 124, width: 124, child: ProgressLoading())) : controller.gvSmartMonitoring,
          Container(
