    ...
    Widget build(BuildContext context) {
        return SizedBox(
            ...
            child: ElevatedButton(
                ...
                backgroundColor: GlobalVar.black,
                ...
                child: Container(
                    ...
                    child: Row(
                        children: [
                            ...
                            Text("Login with Apple ID", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: GlobalVar.medium))
                        ]
                    )
                )
            )
