...
class MultipleFormField<T> extends StatelessWidget {
  ...
  MultipleFormField(
      ...
      this.decoration = const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)), border: Border.fromBorderSide(BorderSide(color: GlobalVar.grayBackground, width: 3))),
          ...
          children: [
            Container(
              ...
              child: Column(children: [
                child,
                ButtonFill(
                    controller: GetXCreator.putButtonFillController("multipleFormFieldAdd${controller.tag}"),
