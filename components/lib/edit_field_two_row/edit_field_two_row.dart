...
class EditFieldTwoRow extends StatelessWidget {
  ...
  EditFieldTwoRow(
      ...
      required this.textUnit1,
      required this.textUnit2,
      required this.maxInput,
      this.inputType = TextInputType.text,
      this.action = TextInputAction.done,
      this.hideLabel = false,
      required this.onTyping1,
      required this.onTyping2,
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: textPrefix1 != null
                                          ? Padding(
                                              padding: const EdgeInsets.all(16.0),
                                              child: Text("$textPrefix2", style: TextStyle(color: controller.activeField.isTrue ? AppColors.primaryOrange : AppColors.black, fontSize: 14)),
                                            )
                                          : null,
                                      suffixIcon: Padding(
                                        padding: const EdgeInsets.all(16),
                                        child: Text(textUnit1, style: TextStyle(color: controller.activeField.isTrue ? AppColors.primaryOrange : AppColors.black, fontSize: 14)),
                                      ),
                                      ...
                                      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: const BorderSide(color: AppColors.primaryLight)),
                                      filled: true,
                                    ),
                                  ),
                                ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: Padding(
                                        padding: const EdgeInsets.all(16),
                                        child: Text(textUnit2, style: TextStyle(color: controller.activeField.isTrue ? AppColors.primaryOrange : AppColors.black, fontSize: 14)),
                                      ),
                                      fillColor: controller.activeField.isTrue ? AppColors.primaryLight : AppColors.grey,
                                      focusedBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10.0),
