    ...
    return Obx(() => TextField(
        ...
        decoration: InputDecoration(
            ...
            prefixIcon: addPrefixDropdown
                        ...
                        child: Column(children: [
                          ...
                          DropdownButtonHideUnderline(
                              child: DropdownButton2<String>(
                                  ...
                                  items: controller.items.map((item) => DropdownMenuItem(value: item, child: Text(item, style: GlobalVar.subTextStyle.copyWith(fontSize: 14, color: GlobalVar.black)))).toList(),
                ...
                : Padding(padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 8), child: SvgPicture.asset("images/search_icon.svg")),
