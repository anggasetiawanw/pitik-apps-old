...
class UserApi {
    ...
    @JSON()
    void register(@Parameter("fullName") String fullName, @Parameter("email") String email, @Parameter("phoneNumber") String phoneNumber, @Parameter("businessYear") double businessYear,
                  @Parameter("coopType") int coopType, @Parameter("coopCapacity") double capacity, @Parameter("coopLocation") String location, @Parameter("address") String address,
                  @Parameter("region") String city, @Parameter("province") String province, @Parameter("district") String district) {}
