...
class SmartCameraApi {
  ...
  void getRecordImages(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Header('X-APP-ID') String xAppId, @Path() String path, @Query('roomId') String roomId, @Query('\$page') int page, @Query('\$limit') int limit) {}
