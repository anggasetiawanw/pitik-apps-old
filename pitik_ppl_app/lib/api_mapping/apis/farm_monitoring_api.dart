...
class FarmMonitoringApi {
  ...
  void getPerformHistory(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('\$page') int page, @Query('\$limit') int limit, @Query('\$order') String order) {}
