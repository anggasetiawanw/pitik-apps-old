...
class SmartMonitoringApi {
  ...
  void realTime(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('sensorType') String sensorType, @Query('farmingCycleId') int farmingCycleId, @Query('days') String days, @Query('farmId') String farmId,
      @Query('coopId') String coopId, @Query('roomId') String roomId) {}
  ...
  void realTimeSmartController(
      @Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('type') String type, @Query('deviceId') String deviceId, @Query('day') String day, @Query('coopId') String coopId, @Query('\$order') String order) {}
