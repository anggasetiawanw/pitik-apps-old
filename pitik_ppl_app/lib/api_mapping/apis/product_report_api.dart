...
class ProductReportApi {
  ...
  void getListPurchaseRequest(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('isBeforeDoc') bool isBeforeDoc, @Query('type') String type,
      @Query('fromDate') String fromDate, @Query('untilDate') String untilDate) {}
  ...
  @GET(value: 'v2/purchase-requests', as: ProcurementListResponse, error: ErrorResponse)
  void getListPurchaseRequestForCoopRest(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('coopId') String coopId, @Query('isBeforeDoc') bool isBeforeDoc, @Query('type') String type,
      @Query('fromDate') String fromDate, @Query('untilDate') String untilDate) {}
  ...
  void getListPurchaseOrder(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('isBeforeDoc') bool isBeforeDoc, @Query('type') String type,
      @Query('fromDate') String fromDate, @Query('untilDate') String untilDate, @Query('status') String status, @Query('isFulfilled') bool isFulfilled) {}
  ...
  /// such as "pending", "approved", "rejected", etc.
  @GET(value: 'v2/purchase-orders', as: ProcurementListResponse, error: ErrorResponse)
  void getListPurchaseOrderForCoopRest(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('coopId') String coopId, @Query('isBeforeDoc') bool isBeforeDoc, @Query('type') String type, @Query('fromDate') String fromDate,
      @Query('untilDate') String untilDate, @Query('status') String status) {}
  ...
  void searchOvkUnit(
      @Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('productName') String productName, @Query('branchId') String branchId, @Query('type') String type, @Query('\$page') int page, @Query('\$limit') int limit) {}
  ...
  void getTransferSend(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('type') String type, @Query('fromDate') String fromDate, @Query('untilDate') String untilDate) {}
  ...
  @GET(value: 'v2/transfer-requests/exit', as: ProcurementListResponse, error: ErrorResponse)
  void getTransferSendByStatus(@Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('type') String type, @Query('status') String status1, @Query('status') String status2) {}
  ...
  void getTransferReceived(
      @Header('Authorization') String authorization, @Header('X-ID') String xId, @Query('farmingCycleId') String farmingCycleId, @Query('type') String type, @Query('fromDate') String fromDate, @Query('untilDate') String untilDate) {}
