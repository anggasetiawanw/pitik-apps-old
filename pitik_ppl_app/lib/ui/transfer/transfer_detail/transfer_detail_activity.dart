                ...
                : ListView(children: [
                    Container(
                        ...
                        child: Column(children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Detail Transfer', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: Colors.black)), controller.getStatus()]),
                          const SizedBox(height: 12),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Tanggal Pengiriman', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)), controller.getTransferDate()]),
                          ...
                          controller.coop.isOwnFarm != null && controller.coop.isOwnFarm!
                              ? Column(
                                  children: [
                                    ...
                                    Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [Text('Tujuan Transfer', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)), controller.getPurposeTransfer()])
                                  ],
                                )
                              : const SizedBox(),
                          const SizedBox(height: 8),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Kandang Tujuan', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)), controller.getCoopTarget()])
                        ])),
