...
import 'transfer_request_controller.dart';
                ...
                : ListView(
                    children: [
                      ...
                      controller.isFeed.isTrue
                          ? Column(children: [controller.transferCoopTargetField, const SizedBox(height: 16), controller.feedMultipleFormField])
                          : Column(
                              children: [controller.transferPurposeField, controller.isPurposeCoop.isTrue ? controller.transferCoopTargetField : const SizedBox(), const SizedBox(height: 16), controller.ovkMultipleFormField],
                            )
                    ],
                  ))));
  }
