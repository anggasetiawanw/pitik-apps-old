...
class TransferRequestController extends GetxController {
  ...
  void onInit() {
    ...
    transferDateField = DateTimeField(
        controller: GetXCreator.putDateTimeFieldController('transferDateField'),
        label: 'Tanggal Pengiriman',
        hint: '20/02/2022',
        alertText: 'Tanggal Pengiriman harus diisi..!',
    ...
    transferTypeField = SpinnerField(
        controller: GetXCreator.putSpinnerFieldController('transferTypeField'),
    ...
    transferPurposeField = SpinnerField(
        controller: GetXCreator.putSpinnerFieldController('transferPurposeField'),
    ...
    transferPhotoField = MediaField(
        controller: GetXCreator.putMediaFieldController('transferPhotoField'),
        label: 'Upload foto Sapronak',
        hideLabel: true,
        hint: 'Upload foto Sapronak',
        alertText: 'Harus diisi..!',
    ...
    feedQuantityField = EditField(
        controller: GetXCreator.putEditFieldController('transferFeedQuantity'), label: 'Total', hint: 'Ketik di sini', alertText: 'Total belum diisi..!', textUnit: '', maxInput: 20, inputType: TextInputType.number, onTyping: (text, field) {});
    ...
    feedMultipleFormField = MultipleFormField<Product>(
        ...
        child: Column(children: [feedSpinnerField, feedQuantityField]));
    ...
    ovkQuantityField = EditField(
        controller: GetXCreator.putEditFieldController('transferOvkQuantity'), label: 'Total', hint: 'Ketik di sini', alertText: 'Total belum diisi..!', textUnit: '', maxInput: 20, inputType: TextInputType.number, onTyping: (text, field) {});
    ...
    ovkMultipleFormField = MultipleFormField<Product>(
        ...
        child: Column(children: [ovkSpinnerField, ovkQuantityField]));
  ...
  void _initializeFillForm() {
    ...
    // fill method order
    transferMethodField.getController().setSelected(procurement.logisticOption == null
        ? ''
        : procurement.logisticOption == 'DisediakanProcurement'
            ? 'Disediakan Procurement'
            : procurement.logisticOption!);
    ...
    if (isFeed.value) {
      ...
      transferPurposeField.getController().setSelected(procurement.route == null
          ? ''
          : procurement.route == 'COOP-TO-COOP'
              ? 'Kandang'
              : 'Unit');
      transferCoopTargetField.getController().setSelected(procurement.coopTargetName ?? '');
                                      ...
                                      AuthImpl().get().then((auth) {
                                        if (auth != null) {
                                          final String requestedDate =
                                              '${Convert.getYear(transferDateField.getLastTimeSelected())}-${Convert.getMonthNumber(transferDateField.getLastTimeSelected())}-${Convert.getDay(transferDateField.getLastTimeSelected())}';
                                          final String? coopId = isFeed || transferPurposeField.getController().selectedIndex == 0 ? (transferCoopTargetField.getController().getSelectedObject() as Coop).id! : null;
                                          ...
                                          final Procurement requestBody = Procurement(
  ...
  Product getFeedSelectedObject() {
    if (feedSpinnerField.getController().getSelectedObject() != null) {
      final Product product = feedSpinnerField.getController().getSelectedObject();
  ...
  Product getOvkSelectedObject() {
    if (ovkSpinnerField.getController().getSelectedObject() != null) {
      final Product product = ovkSpinnerField.getController().getSelectedObject();
