...
class ListTransferController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  void showMenuBottomSheet() {
    final DateTimeField fromDateField = DateTimeField(
        controller: GetXCreator.putDateTimeFieldController('filterTransferFromDateField'),
        label: 'Tanggal Dari',
        hint: 'Pilih tanggal',
    ...
    final DateTimeField untilDateField = DateTimeField(
        controller: GetXCreator.putDateTimeFieldController('filterTransferUntilDateField'),
    ...
    final SpinnerField typeField = SpinnerField(
        controller: GetXCreator.putSpinnerFieldController('filterTransferTypeField'),
        label: 'Jenis Transfer',
        hint: 'Pilih salah satu',
        alertText: 'Harus pilih jenis..!',
        items: const {'Pakan': false, 'OVK': false},
            ...
            child: Padding(
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      ButtonFill(
                          controller: GetXCreator.putButtonFillController('btnFilterTransferList'),
