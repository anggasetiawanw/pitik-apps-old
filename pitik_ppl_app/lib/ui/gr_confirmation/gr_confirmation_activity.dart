...
import 'gr_confirmation_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        bottomNavigationBar: controller.isLoading.isTrue
            ...
            : controller.procurement.statusText != GlobalVar.DIPROSES &&
                    controller.procurement.statusText != GlobalVar.DITOLAK &&
                    controller.procurement.statusText != GlobalVar.ABORT &&
                    controller.procurement.statusText != GlobalVar.LENGKAP &&
                    controller.procurement.statusText != GlobalVar.DITERIMA
                ? Container(
        ...
        body: Padding(
            ...
            child: controller.isLoading.isFalse
                ? ListView(children: [
                    Container(
                        ...
                        child: Column(children: [
                          Row(
                              ...
                              children: [Text('Detail ${controller.isFromTransfer ? 'Transfer' : 'Order'}', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: Colors.black)), controller.getStatus()]),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(controller.procurement.erpCode ?? '-', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                          ]),
                          if (!controller.isFromTransfer) ...[
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text(controller.procurement.purchaseRequestErpCode ?? '-', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                            ])
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text(controller.procurement.route == 'COOP-TO-BRANCH' ? 'Unit' : 'Kandang', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                            ])
                          ],
                          const SizedBox(height: 8),
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(
                                controller.procurement.type == null
                                    ? '-'
                                    : controller.procurement.type == 'pakan'
                                        ? 'Pakan'
                                        : 'OVK',
                                  ...
                                  children: [
                                    if (!controller.isFromTransfer) ...[
                                      ...
                                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                        ...
                                        Text(
                                            controller.procurement.mergedLogistic == null
                                                ? '-'
                                                : controller.procurement.mergedLogistic!
                                                    ? 'Ya'
                                                    : 'Tidak',
                                            style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                      ])
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      controller.isFromTransfer
                                          ? Text(controller.procurement.coopSourceName == null ? '-' : controller.procurement.coopSourceName!, style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                          : Text(controller.procurement.mergedLogisticCoopName == null ? '-' : controller.procurement.mergedLogisticCoopName!,
                                              style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                    ])
                                  ],
                                )
                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          ...
                                          Text(
                                              controller.procurement.isTransferRequest != null && controller.procurement.isTransferRequest!
                                                  ? 'Unit'
                                                  : controller.procurement.details.isEmpty && controller.procurement.internalOvkTransferRequest != null
                                                      ? 'Vendor'
                                                      : '-',
                                              style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                        ]),
                    ...
                    const SizedBox(height: 8),
                    controller.procurement.statusText == GlobalVar.SEBAGIAN || controller.procurement.statusText == GlobalVar.DIKIRIM
                        ? Container(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                  child: Text('Pastikan barang tidak ada yang di Retur, Jika sudah Diterima maka Barang pada PO ini tidak bisa di Retur lagi',
                    ...
                    controller.procurement.statusText == GlobalVar.DIPROSES || controller.procurement.statusText == GlobalVar.DITOLAK
                        ...
                        : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            controller.isAlreadyReturned()
                                    ...
                                    children: [
                                      Container(
                                          ...
                                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            const SizedBox(width: 8),
                                            Expanded(
                                                child: Text('Ada pengurangan jumlah ${controller.procurement.type == 'pakan' ? 'Pakan' : 'OVK'} pada proses Retur',
                                                    style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.blue)))
                                          ])),
                                      const SizedBox(height: 16),
                                      Text('${controller.procurement.type == 'pakan' ? 'Pakan' : 'OVK'} Diretur', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: GlobalVar.black)),
                                      const SizedBox(height: 8),
                                ...
                                : const SizedBox(),
                            controller.procurement.goodsReceipts.isNotEmpty && controller.isGrNotAllReturned()
                                ? Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(
                                        controller.procurement.statusText == GlobalVar.SEBAGIAN
                                            ? 'Penerimaan Sebelumnya'
                                            : controller.procurement.statusText == GlobalVar.LENGKAP
                                                ? '${controller.procurement.type == 'pakan' ? 'Pakan' : 'OVK'} Diterima'
