...
class SmartScaleHarvestDetailController extends GetxController {
  ...
  void onInit() {
    ...
    // try hardcoded
    final List<SmartScaleRecord?> record = [
    ...
    realization.records = [RealizationRecord(weighingNumber: 'B8819200AC', tonnage: 1002.4, quantity: 199, page: 1, averageWeight: 2.3, image: '', details: record)];
                ...
                child: Container(
                    ...
                    child: SizedBox(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Expanded(
                              child: ButtonFill(
                                  controller: GetXCreator.putButtonFillController('btnSmartScaleHarvestEditRealization'),
                                  label: 'Edit',
                                  onClick: () {
                                    final Harvest harvest = Harvest(
                                        id: realization.id,
                                    ...
                                    Get.toNamed(RoutePage.smartScaleHarvestForm,
                                            arguments: [coop, harvest, realization.weighingTime, realization.truckDepartingTime, realization.driver, realization.witnessName, realization.receiverName, realization.weigherName])!
                                        .then((value) => Get.back());
                                  })),
                          const SizedBox(width: 16),
                          Expanded(
                              child: ButtonOutline(
                                  controller: GetXCreator.putButtonOutlineController('btnSmartScaleHarvestPreviewRealization'),
                                  label: 'Preview',
                                  onClick: () {
                ...
                child: Container(
                    ...
                    child: SizedBox(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Expanded(
                            child: ButtonFill(
                                controller: GetXCreator.putButtonFillController('btnSmartScaleHarvestNextRealization'),
                                label: buttonNextTitle.value,
                                onClick: () {
  ...
  void _getSmartScaleDataWidget() {
    if (realization.records.isNotEmpty && realization.records[0]!.details.isNotEmpty) {
      ...
      for (var element in realization.records[0]!.details) {
        final EditField totalChick = EditField(
            controller: GetXCreator.putEditFieldController('totalChickenDetailSmartScaleHarvest$number'),
            label: '',
            hint: '',
            alertText: '',
            hideLabel: true,
        ...
        final EditField totalWeight = EditField(
            controller: GetXCreator.putEditFieldController('totalWeighingDetailSmartScaleHarvest$number'),
            label: '',
            hint: '',
            alertText: '',
            hideLabel: true,
  ...
  Row _createDataScale({required int number, required EditField totalChick, required EditField totalWeight}) => Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Padding(
            padding: const EdgeInsets.only(bottom: 8, top: 8),
            child: Container(
                height: 50,
                width: 40,
                decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(8)), color: GlobalVar.gray),
                child: Padding(padding: const EdgeInsets.only(bottom: 5), child: Center(child: Text('$number', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: const Color(0xFF9E9D9D))))))),
        Expanded(child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const SizedBox(width: 8), Expanded(child: totalChick), const SizedBox(width: 8), Expanded(child: totalWeight)]))
      ]);
  ...
  Future<void> _createPdf() async {
        ...
        build: (pw.Context context) {
          return pw.Column(children: [
            pw.Row(
                ...
                children: [pw.Text('No. Timbang', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.weighingNumber ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Tanggal Tangkap', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.harvestDate ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Nama Kandang', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.coopName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Alamat', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.addressName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Jam Tangkap', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.weighingTime ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Jam Berangkat', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.truckDepartingTime ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Bakul', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.bakulName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Nama Sopir', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.driver ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Nopol Kendaraan', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.truckLicensePlate ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            ...
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Jumlah Ayam', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text('${realization.quantity ?? '-'} Ekor', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Alasan Panen', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.reason ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 16),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Diketahui Oleh', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.witnessName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Diterima Oleh', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.receiverName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 8),
            pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [pw.Text('Ditimbang Oleh', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)), pw.Text(realization.weigherName ?? '-', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13))]),
            pw.SizedBox(height: 16),
            pw.Table(
    ...
    final String fullPathIncludeName = '${root.path}/${DateTime.now().millisecondsSinceEpoch}_SmartScaleHarvest.pdf';
