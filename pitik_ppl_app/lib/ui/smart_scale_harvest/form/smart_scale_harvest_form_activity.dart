...
import 'smart_scale_harvest_form_controller.dart';
            ...
            : SizedBox(
                child: Container(
                    ...
                    child: SizedBox(
                        ...
                        child: ButtonFill(controller: GetXCreator.putButtonFillController('btnSmartScaleHarvestStartWeighing'), label: controller.harvest.weighingNumber != null ? 'Simpan' : 'Mulai Timbang', onClick: () => controller.submit())))),
        body: Container(
            ...
            child: controller.isLoading.isTrue
                ...
                : ListView(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: controller.dtfHarvestedTime), const SizedBox(width: 8), Expanded(child: controller.dtfOngoingTime)]),
                    controller.efBakulName,
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: controller.efDriverName), const SizedBox(width: 8), Expanded(child: controller.efPlateNumber)]),
                    const SizedBox(height: 16),
