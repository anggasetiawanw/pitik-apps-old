...
class SmartScaleHarvestFormController extends GetxController {
    ...
    void onInit() {
        ...
        dtfHarvestedDate = DateTimeField(controller: GetXCreator.putDateTimeFieldController("smartScaleHarvestFormHarvestedDate"), label: "Tanggal Tangkap", hint: "2022-08-25", alertText: "Harus Diisi..!", flag: DateTimeField.DATE_FLAG,
        ...
        dtfHarvestedTime = DateTimeField(controller: GetXCreator.putDateTimeFieldController("smartScaleHarvestFormHarvestedTime"), label: "Jam Tangkap", hint: "Ketik disini", alertText: "Harus Diisi..!", flag: DateTimeField.TIME_FLAG,
        ...
        dtfOngoingTime = DateTimeField(controller: GetXCreator.putDateTimeFieldController("smartScaleHarvestFormOngoingTime"), label: "Jam Berangkaat", hint: "Ketik disini", alertText: "Harus Diisi..!", flag: DateTimeField.TIME_FLAG,
            onDateTimeSelected: (date, field) => field.controller.setTextSelected('${Convert.getHour(date)}:${Convert.getMinute(date)}:${Convert.getSecond(date)}')
        );
