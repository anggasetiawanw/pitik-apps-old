    ...
    Widget build(BuildContext context) {
        ...
        return SafeArea(
            child: Scaffold(
                            ...
                            itemBuilder: (_) => <PopupMenuItem<String>>[
                                PopupMenuItem<String>(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text('Baca Semua', style: GlobalVar.blackTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium))
                                    )
                                )
                            ],
                ...
                body: Obx(() => controller.notificationList.isEmpty ? Center(child: Text("Tidak ada notifikasi", style: GlobalVar.blackTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium))) : RawScrollbar(
                    ...
                    child: RefreshIndicator(
                        ...
                        child: controller.isLoading.isTrue ? Padding(
