...
import 'layer_daily_report_form_controller.dart';
                        ...
                        child: controller.state.value == 0
                            ? Padding(
                                ...
                                child: ListView(children: [
                                  ...
                                  controller.efWeight,
                                  controller.efCulled,
                                  controller.isLoadingChickDead.isTrue
                                      ? SizedBox(
                                          height: 50,
                            ...
                            : controller.state.value == 1
                                ...
                                : Padding(
                                    ...
                                    child: ListView(children: [
                                      ...
                                      Row(children: [Expanded(child: controller.efUtuhCoklat), const SizedBox(width: 8), Expanded(child: controller.efUtuhCoklatTotal)]),
                                      Row(children: [Expanded(child: controller.efUtuhKrem), const SizedBox(width: 8), Expanded(child: controller.efUtuhKremTotal)]),
                                      Row(children: [Expanded(child: controller.efRetak), const SizedBox(width: 8), Expanded(child: controller.efRetakTotal)]),
                                      Row(children: [Expanded(child: controller.efPecah), const SizedBox(width: 8), Expanded(child: controller.efPecahTotal)]),
                                      Row(children: [Expanded(child: controller.efKotor), const SizedBox(width: 8), Expanded(child: controller.efKotorTotal)]),
                                      const SizedBox(height: 16),
                                      ...
                                      controller.isLoadingRecodingCard.isTrue
                                          ? SizedBox(
                                              height: 50,
                                              width: MediaQuery.of(context).size.width - 32,
                                              child: Padding(
