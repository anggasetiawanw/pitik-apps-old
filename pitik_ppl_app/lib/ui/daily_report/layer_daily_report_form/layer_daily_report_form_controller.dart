...
class LayerDailyReportFormController extends GetxController {
  ...
  EditField efDead = EditField(
      controller: GetXCreator.putEditFieldController('layerDailyFormDead'), label: 'Kematian', hint: 'Ketik di sini', alertText: 'Harus diisi..!', textUnit: 'Ekor', maxInput: 100, inputType: TextInputType.number, onTyping: (text, field) {});
  ...
  EditField feedQuantityField = EditField(
  ...
  SpinnerField spOvkReason = SpinnerField(
      controller: GetXCreator.putSpinnerFieldController('layerDailyFormOvkReason'),
      label: 'Alasan',
  ...
  SpinnerField spAbnormalEgg = SpinnerField(
      controller: GetXCreator.putSpinnerFieldController('layerDailyFormAbnormalEgg'), label: 'Ada Telur Abnormal?', hint: 'Pilih salah satu', alertText: 'Harus dipilih..!', items: const {'Ya': false, 'Tidak': false}, onSpinnerSelected: (text) {});

  EditField efTotal =
      EditField(controller: GetXCreator.putEditFieldController('layerDailyFormTotal'), label: 'Total', hint: 'Auto', alertText: 'Harus diisi..!', textUnit: 'Butir', maxInput: 100, inputType: TextInputType.number, onTyping: (text, field) {});

  EditField efBeratTotal =
      EditField(controller: GetXCreator.putEditFieldController('layerDailyFormBeratTotal'), label: 'Berat Total', hint: 'Auto', alertText: 'Harus diisi..!', textUnit: 'kg', maxInput: 100, inputType: TextInputType.number, onTyping: (text, field) {});
  ...
  void onInit() {
    ...
    mfChickDead = MediaField(
        controller: GetXCreator.putMediaFieldController('layerDailyFormChickDead'),
    ...
    mfRecordingCard = MediaField(
        controller: GetXCreator.putMediaFieldController('layerDailyFormRecordingCard'),
    ...
    reasonMultipleFormField = MultipleFormField<MortalityReason>(
        ...
        child: Column(children: [spReason, efDead]));
    ...
    feedMultipleFormField = MultipleFormField<Product>(
        ...
        decoration: const BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(10), bottomRight: Radius.circular(10)), border: Border.fromBorderSide(BorderSide(color: GlobalVar.grayBackground, width: 3))),
        onAfterAdded: () {
        ...
        child: Column(children: [feedSuggestField, feedQuantityField]));
    ...
    ovkMultipleFormField = MultipleFormField<Product>(
        ...
        child: Column(children: [ovkSuggestField, ovkQuantityField, spOvkReason]));

    // Initialize for Egg Production
    efUtuhCoklat = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormUtuhCoklat'),
        label: 'Utuh Coklat',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'Butir',
    ...
    efUtuhCoklatTotal = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormUtuhCoklatTotal'),
        label: 'Total',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'kg',
    ...
    efUtuhKrem = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormUtuhKrem'),
        label: 'Utuh Krem',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'Butir',
    ...
    efUtuhKremTotal = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormUtuhKremTotal'),
        label: 'Total',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'kg',
    ...
    efRetak = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormRetak'),
        label: 'Retak',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'Butir',
    ...
    efRetakTotal = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormRetakTotal'),
        label: 'Total',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'kg',
    ...
    efPecah = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormPecah'),
        label: 'Pecah',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'Butir',
    ...
    efPecahTotal = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormPecahTotal'),
        label: 'Total',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'kg',
    ...
    efKotor = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormKotor'),
        label: 'Kotor',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'Butir',
    ...
    efKotorTotal = EditField(
        controller: GetXCreator.putEditFieldController('layerDailyFormKotorTotal'),
        label: 'Total',
        hint: 'Ketik di sini',
        alertText: 'Harus diisi..!',
        textUnit: 'kg',
  ...
  void _fillData() {
    ...
    for (var reason in report.mortalityList) {
      reasonMultipleFormField.controller.addData(child: _createChildAdded(getReason(data: reason), getQuantityReason(data: reason)), object: reason, key: getReason(data: reason));
    }
    ...
    spAbnormalEgg.controller.setSelected(report.isAbnormal != null && report.isAbnormal!
        ? 'Ya'
        : report.isAbnormal != null && !report.isAbnormal!
            ? 'Tidak'
            : '');
  ...
  void _changeHarvestedEggData({required String productName, required EditField editField, required String producItemId, bool isQuantity = true}) {
    ...
    if (!isContain) {
      report.harvestedEgg.add(Products(quantity: isQuantity ? editField.getInputNumber()?.toInt() : 0, weight: !isQuantity ? editField.getInputNumber() : 0.0, productItemId: producItemId, productItem: Products(name: productName, uom: 'Butir')));
    }
  }
  ...
  MortalityReason getReasonSelectedObject() {
    if (efDead.getInputNumber() != null) {
      final MortalityReason deadReason = MortalityReason(cause: spReason.controller.textSelected.value, quantity: efDead.getInputNumber()?.toInt());
  ...
  MortalityReason getReasonSelectedObjectWhenIncreased(MortalityReason oldReason) {
    if (efDead.getInputNumber() != null) {
      final MortalityReason deadReason = MortalityReason(cause: spReason.controller.textSelected.value, quantity: (oldReason.quantity ?? 0) + (efDead.getInputNumber() ?? 0).toInt());
  ...
  void nextPage() {
    ...
    if (state.value == 0) {
      ...
      if (reasonMultipleFormField.controller.listObjectAdded.isEmpty) {
        Get.snackbar('Pesan', 'Alasan kematian masih kosong, silahkan isi minimal satu..!', snackPosition: SnackPosition.TOP, duration: const Duration(seconds: 5), colorText: Colors.white, backgroundColor: Colors.red);
        isPass = false;
      }
      ...
      if (feedMultipleFormField.controller.listObjectAdded.isEmpty) {
        Get.snackbar('Pesan', 'Konsumsi Pakan masih kosong, silahkan isi minimal satu..!', snackPosition: SnackPosition.TOP, duration: const Duration(seconds: 5), colorText: Colors.white, backgroundColor: Colors.red);
        isPass = false;
      }
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    SizedBox(
                                        ...
                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          Expanded(
                                              child: ButtonFill(
                                                  controller: GetXCreator.putButtonFillController('btnLayerDailyReportYes'),
                                                  label: 'Yakin',
                                                  onClick: () {
                                          ...
                                          const SizedBox(width: 16),
                                          Expanded(child: ButtonOutline(controller: GetXCreator.putButtonOutlineController('btnLayerDailyReportNo'), label: 'Tidak Yakin', onClick: () => Navigator.pop(Get.context!)))
                                        ])),
                                    const SizedBox(height: 32)
                                  ])))),
                    ));
  ...
  void _pushDailyReportToServer() => AuthImpl().get().then((auth) {
        if (auth != null) {
          ...
          final Report bodyReport = Report(
              ...
              feedConsumptions: feedMultipleFormField.controller.listObjectAdded.entries
                  .map((entry) {
                  ...
                  .toList()
                  .cast<Product>(),
              ovkConsumptions: ovkMultipleFormField.controller.listObjectAdded.entries
                  .map((entry) {
