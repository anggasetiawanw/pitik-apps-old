                  ...
                  child: Container(
                    ...
                    child: RawScrollbar(
                      ...
                      child: RefreshIndicator(
                          onRefresh: () => Future.delayed(const Duration(milliseconds: 200), () {} //GENERATE DATA
                              ),
                          child: controller.isLoadingList.isTrue
                              ...
                              : ListView.builder(physics: const AlwaysScrollableScrollPhysics(), itemCount: controller.reportList.length, itemBuilder: (context, index) => listCard(controller.reportList[index]))),
                    ),
                  ),
                ))
        ],
