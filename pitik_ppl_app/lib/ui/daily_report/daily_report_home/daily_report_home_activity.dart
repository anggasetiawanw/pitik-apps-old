...
import 'daily_report_home_controller.dart';
      ...
      return GestureDetector(
          onTap: () {
            if (report.status == EnumDailyReport.FILL_SOON) {
              Get.toNamed(controller.coop!.farmCategory == 'LAYER' ? RoutePage.layerDailyReportForm : RoutePage.dailyReportForm, arguments: [controller.coop!, report])!.then((value) => controller.getDailyReport());
            } else {
                ...
                Expanded(
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Column(
                        ...
                        children: [Text('Laporan Harian', style: GlobalVar.blackTextStyle.copyWith(fontWeight: FontWeight.bold)), const SizedBox(height: 4), Text('${report?.date}', style: GlobalVar.blackTextStyle.copyWith(fontSize: 12))]),
