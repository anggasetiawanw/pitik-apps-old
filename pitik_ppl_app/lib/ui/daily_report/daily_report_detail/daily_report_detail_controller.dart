...
class DailyReportDetailController extends GetxController {
  ...
  late ButtonFill btEdit = ButtonFill(
      controller: GetXCreator.putButtonFillController('editDailyReportDetail'),
      label: 'Edit',
      onClick: () => Get.toNamed(RoutePage.dailyReportForm, arguments: [coop!, report, true, reportDetail])!.then((value) => value != null ? Get.back() : getDetailReport()));
  ...
  late ButtonOutline btEditOutline = ButtonOutline(
      controller: GetXCreator.putButtonOutlineController('editDailyReportDetailOutline '), label: 'Edit', onClick: () => Get.toNamed(RoutePage.dailyReportForm, arguments: [coop!, report, true, reportDetail])!.then((value) => getDetailReport()));
...
class DailyReportDetailBindings extends Bindings {
  ...
  @override
  void dependencies() => Get.lazyPut(() => DailyReportDetailController(context: context));
}
