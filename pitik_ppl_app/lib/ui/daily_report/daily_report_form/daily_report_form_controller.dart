...
class DailyReportFormController extends GetxController with GetSingleTickerProviderStateMixin {
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                            child: Text(
                                          getOvkProductName(product: ovkStockSummaryList[index - 1]),
                                          style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium),
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(report.date!, style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                      ]),
                      const SizedBox(height: 16),
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('Bobot', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium)),
                        Text('${efBobot.getInputNumber()} gr', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                      ]),
                      const SizedBox(height: 16),
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('Kematian', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium)),
                        Text('${efKematian.getInputNumber()} ekor', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                      ]),
                      const SizedBox(height: 16),
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text('Culling', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium)),
                        Text('${efCulling.getInputNumber()} Ekor', style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                      ]),
                      const SizedBox(height: 16),
                        ...
                        child: Column(
                          ...
                          return Padding(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Expanded(child: Text(getFeedProductName(product: mffKonsumsiPakan.getController().listObjectAdded[entry.key]), style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))),
                                Text(getFeedQuantity(product: mffKonsumsiPakan.getController().listObjectAdded[entry.key]), style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                              ]));
                        }).toList()),
                      ),
                      const SizedBox(height: 16),
                          ...
                          child: Column(
                            ...
                            return Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  Text(getOvkQuantity(product: mffKonsumsiOVK.getController().listObjectAdded[entry.key]), style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                                ]));
                          }).toList())),
                                ...
                                child: ButtonFill(
                                    ...
                                    onClick: () {
                                      ...
                                      AuthImpl().get().then((auth) {
                                        if (auth != null) {
                                          final Report requestBody = Report(
                                              ...
                                              feedConsumptions: mffKonsumsiPakan
                                                  .getController()
                                                  .listObjectAdded
                                                  .entries
                                                  .map((entry) {
                                                  ...
                                                  .toList()
                                                  .cast<Product>(),
                                              ovkConsumptions: mffKonsumsiOVK
                                                  .getController()
                                                  .listObjectAdded
                                                  .entries
                                                  .map((entry) {
  ...
  void _pushDailyReportToServer(List<dynamic> body) => Service.push(
  ...
  void fillEditForm() {
    ...
    if (reportDetail.feedConsumptions != null && reportDetail.feedConsumptions!.isNotEmpty) {
      for (var product in reportDetail.feedConsumptions!) {
        mffKonsumsiPakan.getController().addData(child: _createChildAdded(getFeedProductName(product: product), getFeedQuantity(product: product)), object: product, key: getFeedProductName(product: product));
      }
    }
    ...
    if (reportDetail.ovkConsumptions != null && reportDetail.ovkConsumptions!.isNotEmpty) {
      for (var product in reportDetail.ovkConsumptions!) {
        mffKonsumsiOVK.getController().addData(child: _createChildAdded(getOvkProductName(product: product), getOvkQuantity(product: product)), object: product, key: getOvkProductName(product: product));
      }
    }
  }
  ...
  Product getFeedSelectedObject() {
    if (sfMerkPakan.getController().getSelectedObject() != null) {
      final Product product = sfMerkPakan.getController().getSelectedObject();
  ...
  Product getOvkSelectedObject() {
    if (sfJenisOvk.getController().getSelectedObject() != null) {
      final Product product = sfJenisOvk.getController().getSelectedObject();
...
class DailyReportFormBindings extends Bindings {
  ...
  @override
  void dependencies() => Get.lazyPut(() => DailyReportFormController(context: context));
}
