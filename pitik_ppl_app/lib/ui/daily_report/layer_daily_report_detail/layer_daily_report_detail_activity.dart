...
import 'layer_daily_report_detail_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        bottomNavigationBar: controller.isLoading.isTrue
            ? const SizedBox()
            : controller.isCanRevision.isTrue
                ? Container(
                ...
                : controller.reportArguments.status! != EnumDailyReport.LATE && controller.reportArguments.status! != EnumDailyReport.FINISHED && controller.report.value.revisionStatus != 'REVISED'
                    ? Container(
                        padding: const EdgeInsets.only(left: 16, right: 16, bottom: 16),
                        decoration: const BoxDecoration(color: Colors.white, boxShadow: [BoxShadow(color: Colors.black38, spreadRadius: 0, blurRadius: 2)]),
            ...
            : RawScrollbar(
                ...
                child: Padding(
                    ...
                    child: ListView(children: [
                      ...
                      const SizedBox(height: 16),
                      controller.report.value.mortalityList.isNotEmpty
                          ? Column(children: [
                              Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), border: Border.all(color: GlobalVar.outlineColor, width: 1)),
                                  padding: const EdgeInsets.all(16),
                                  child: Column(
                                      ...
                                      children: List.generate(
                                          controller.report.value.mortalityList.length,
                                          (index) => Column(children: [
                                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                    Text('Kematian', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                                    const SizedBox(height: 4),
                                                    Text('${controller.report.value.mortalityList[index]!.quantity ?? '-'} Ekor', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                                  ]),
                                                  Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                                    ...
                                                    const SizedBox(height: 4),
                                                    Text(controller.report.value.mortalityList[index]!.cause ?? '-', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                                  ])
                                                ]),
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                const SizedBox(height: 4),
                                Text(controller.getEggQuantity(productName: 'Telur Utuh Cokelat'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ]),
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggWeight(productName: 'Telur Utuh Cokelat'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ])
                            ]),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('Total (butir)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggQuantity(productName: 'Telur Utuh Krem'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ]),
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggWeight(productName: 'Telur Utuh Krem'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ])
                            ]),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('Total (butir)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggQuantity(productName: 'Telur Retak'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ]),
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggWeight(productName: 'Telur Retak'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ])
                            ]),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('Total (butir)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggQuantity(productName: 'Telur Pecah'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ]),
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggWeight(productName: 'Telur Pecah'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ])
                            ]),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text('Total (butir)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggQuantity(productName: 'Telur Kotor'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ]),
                              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                                const SizedBox(height: 4),
                                Text(controller.getEggWeight(productName: 'Telur Kotor'), style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                              ])
                            ]),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            ...
                            Text('Total (kg)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                            const SizedBox(height: 4),
                            Text('${controller.report.value.eggDisposal ?? '-'} kg', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.black)),
                            const SizedBox(height: 16),
                            const Divider(color: GlobalVar.outlineColor, height: 1.4),
                            const SizedBox(height: 16),
