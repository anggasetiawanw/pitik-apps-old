                      ...
                      child: Row(
                        ...
                        children: [
                          Row(children: [
                            state == 0
                                ? Container(
                                    decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(4)), color: GlobalVar.primaryOrange),
                                    height: 8,
                                    width: 18,
                                  )
                                : Container(
                                    decoration: const BoxDecoration(color: GlobalVar.gray, shape: BoxShape.circle),
                                    height: 8,
                                    width: 8,
                                  ),
                          ...
                          state == 0 || state == 1
                              ? GestureDetector(
                                  ...
                                  child: Row(
                                    children: [Text('Lewati', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)), const SizedBox(width: 8), const Icon(Icons.arrow_forward_ios, size: 14)],
                                  ),
                                )
                              : const SizedBox(),
                        ],
                  ...
                  Positioned.fill(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          state == 0
                              ? SvgPicture.asset('images/boarding_one_icon.svg')
                              : state == 1
                                  ? SvgPicture.asset('images/boarding_two_icon.svg')
                                  : SvgPicture.asset('images/boarding_three_icon.svg'),
                          const SizedBox(height: 16),
                          state == 0
                              ? Text('Pendapatan Tinggi dan Stabil', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 16, fontWeight: GlobalVar.bold, color: GlobalVar.primaryOrange))
                              : state == 1
                                  ? Text('Kualitas Sapronak Baik dan Teruji', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 16, fontWeight: GlobalVar.bold, color: GlobalVar.primaryOrange))
                          ...
                          state == 0
                              ? Text('Harga ayam kompetitif dengan skema insentif yang adil dan transparan untuk menjamin pendapatan peternak',
                                  textAlign: TextAlign.center, style: GlobalVar.whiteTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText))
                              : state == 1
