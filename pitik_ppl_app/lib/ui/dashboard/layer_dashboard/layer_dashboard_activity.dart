...
import 'layer_dashboard_controller.dart';
...
class LayerDashboardActivity extends GetView<LayerDashboardController> {
  const LayerDashboardActivity({super.key});
        ...
        floatingActionButton: Padding(
            ...
            child: GestureDetector(
                ...
                child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [SvgPicture.asset('images/floating_home_icon.svg')])))),
        bottomNavigationBar: Container(
            ...
            child: ClipRRect(
              ...
              child: BottomNavigationBar(
                  ...
                  currentIndex: controller.homeTab.isTrue
                      ? 0
                      : controller.historyTab.isTrue
                          ? 1
                          : controller.monitorTab.isTrue
                              ? 3
                              : controller.profileTab.isTrue
                                  ? 4
                                  : -1,
