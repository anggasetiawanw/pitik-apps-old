...
class SmartCameraListDayController extends GetxController {
  ...
  Widget addCard({required SmartCameraDay smartCameraDay, bool isRedChild = false}) {
    final DateTime date = Convert.getDatetime(smartCameraDay.date!);
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              smartCameraDay.recordCount == null || smartCameraDay.recordCount == 0
                  ? Text('Belum ada record', style: GlobalVar.blackTextStyle.copyWith(fontWeight: GlobalVar.medium, fontSize: 12, overflow: TextOverflow.clip, color: isRedChild ? GlobalVar.red : GlobalVar.black))
                  : Row(
                      children: [
