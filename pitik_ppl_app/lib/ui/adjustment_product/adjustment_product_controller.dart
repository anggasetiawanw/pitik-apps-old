...
class AdjustmentProductController extends GetxController {
    ...
    void onInit() {
        ...
        // SETUP FEED WIDGET
        feedCategory = SpinnerField(controller: GetXCreator.putSpinnerFieldController("adjustmentProductFeedCategory"), label: "Kategori Pakan", hint: "Pilih Merek Pakan", backgroundField: GlobalVar.primaryLight, alertText: "Kategori Pakan harus dipilih..!",
        ...
        feedQuantityField = EditField(controller: GetXCreator.putEditFieldController("adjustmentProductFeedQuantity"), label: "Total", hint: "Ketik di sini", alertText: "Total belum diisi..!", textUnit: "", maxInput: 20, inputType: TextInputType.number,
            onTyping: (text, field) {}
        );
        ...
        ovkQuantityField = EditField(controller: GetXCreator.putEditFieldController("adjustmentProductOvkQuantity"), label: "Total", hint: "Ketik di sini", alertText: "Total belum diisi..!", textUnit: "", maxInput: 20, inputType: TextInputType.number,
            onTyping: (text, field) {}
        );
                                ...
                                children: [
                                    ...
                                    SizedBox(
                                        ...
                                        child: Row(
                                            ...
                                            children: [
                                                Expanded(
                                                    child: ButtonFill(controller: GetXCreator.putButtonFillController("btnAgreeAdjustmentProduct"), label: "Yakin", onClick: () {
                                                ...
                                                Expanded(
                                                    child: ButtonOutline(controller: GetXCreator.putButtonOutlineController("btnNotAdjustmentProduct"), label: "Tidak Yakin", onClick: () => Navigator.pop(Get.context!))
                                                )
                                            ]
                                        )
                                    ),
