...
import '../../../route.dart';
import 'adjustment_feed_controller.dart';
                ...
                child: ListView(children: [
                  ...
                  Container(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                        ...
                        Expanded(child: Text('Pencatatan konsumsi pakan selama satu siklus berlangsung', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.blue), overflow: TextOverflow.clip))
                      ])),
                  controller.eaNotes,
                  const SizedBox(height: 12),
