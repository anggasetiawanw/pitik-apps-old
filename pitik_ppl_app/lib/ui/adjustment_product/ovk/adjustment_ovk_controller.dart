...
class AdjustmentOvkController extends GetxController {
    ...
    void onInit() {
        ...
        ovkQuantityField = EditField(controller: GetXCreator.putEditFieldController("adjustmentOvkQuantity"), label: "Total", hint: "Ketik di sini", alertText: "Total belum diisi..!", textUnit: "", maxInput: 20, inputType: TextInputType.number,
            onTyping: (text, field) {}
        );
    }
                                ...
                                children: [
                                    ...
                                    SizedBox(
                                        ...
                                        child: Row(
                                            ...
                                            children: [
                                                Expanded(
                                                    child: ButtonFill(controller: GetXCreator.putButtonFillController("btnAgreeAdjustmentOvk"), label: "Yakin", onClick: () {
                                                        ...
                                                        if (ovkQuantityField.getInputNumber() != ovkLeftOver) {
                                                            ...
                                                            AdjustmentClosing body = AdjustmentClosing(
                                                                remarks: eaNotes.getInput(),
                                                                value: ovkQuantityField.getInputNumber()
                                                            );
                                                ...
                                                Expanded(
                                                    child: ButtonOutline(controller: GetXCreator.putButtonOutlineController("btnNotAdjustmentOvk"), label: "Tidak Yakin", onClick: () => Navigator.pop(Get.context!))
                                                )
                                            ]
                                        )
                                    ),
