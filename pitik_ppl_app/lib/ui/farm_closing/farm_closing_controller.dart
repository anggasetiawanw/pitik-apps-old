...
class FarmClosingController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  void onInit() {
    ...
    eaRemarks = EditAreaField(controller: GetXCreator.putEditAreaFieldController('farmClosingMortalityRemarks'), label: 'Catatan', hint: 'Tulis catatan', alertText: 'Harus diisi..!', maxInput: 500, onTyping: (text, field) {});

    _customDialog = CustomDialog(Get.context!, Dialogs.YES_OPTION).listener(CustomDialogListener(onDialogOk: (context, id, packet) => _customDialog.hide(), onDialogCancel: (context, id, packet) {}));
  ...
  void _checkingMortality() {
    final int mortality = efTotalMortality.getInputNumber() == null ? 0 : efTotalMortality.getInputNumber()!.toInt();
  ...
  Row getLabelPoint() {
    if (isOwnFarm()) {
      return Row(
          ...
          children: [Center(child: textPointLabelList[0]), Center(child: textPointLabelList[1]), Center(child: textPointLabelList[2]), Center(child: textPointLabelList[3])]);
    } else {
      return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [Center(child: textPointLabelList[0]), Center(child: textPointLabelList[1]), Center(child: textPointLabelList[2])]);
    }
  }
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            SizedBox(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Expanded(
                                      child: ButtonFill(
                                          controller: GetXCreator.putButtonFillController('btnAgreeFarmClosing'),
                                          label: 'Yakin',
                                          onClick: () {
                                                ...
                                                listener: ResponseListener(
                                                    onResponseDone: (code, message, body, id, packet) {
                                                      ...
                                                      Get.off(TransactionSuccessActivity(
                                                          keyPage: 'farmClosingSuccessPage', message: 'Kamu telah berhasil melakukan\npenutupan siklus produksi', showButtonHome: false, onTapClose: () => Get.back(result: true), onTapHome: () {}));
                                                    },
                                  ...
                                  Expanded(child: ButtonOutline(controller: GetXCreator.putButtonOutlineController('btnNotFarmClosing'), label: 'Tidak Yakin', onClick: () => Navigator.pop(Get.context!)))
                                ])),
              ...
              listener: ResponseListener(
                  onResponseDone: (code, message, body, id, packet) {
                    if ((body as ProcurementListResponse).data.isNotEmpty) {
                      ...
                      _customDialog.title('Perhatian!').message(message).show();
                    }
  ...
  void getFeedTransferList() => TransferCommon.getListSendByStatus(
      coop: coop,
      isLoading: isLoading,
      destinationTransferList: feedTransferList,
      type: 'pakan',
      status1: '0',
      status2: '1',
      onDone: () {
  ...
  void getOvkTransferList() => TransferCommon.getListSendByStatus(
      coop: coop,
      isLoading: isLoading,
      destinationTransferList: ovkTransferList,
      type: 'ovk',
      status1: '0',
      status2: '1',
      onDone: () {
  ...
  void _adjustMortalityClosing() => AuthImpl().get().then((auth) {
        if (auth != null) {
          final AdjustmentClosing adjustMortality = AdjustmentClosing(value: efTotalMortality.getInputNumber(), remarks: eaRemarks.getInput());
            ...
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Padding(
                      ...
                      child: Align(alignment: Alignment.centerLeft, child: Text('Perhatian!', style: GlobalVar.subTextStyle.copyWith(fontSize: 21, fontWeight: GlobalVar.bold, color: GlobalVar.primaryOrange)))),
