...
class DocInController extends GetxController {
  ...
  EditField efMoreDOC = EditField(
      controller: GetXCreator.putEditFieldController('MoreDOC'), label: 'Lebihan DOC', hint: 'Masukan Lebihan DOC', alertText: 'Lebihan DOC belum disi', textUnit: 'Ekor', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});

  EditField efBw = EditField(controller: GetXCreator.putEditFieldController('bwDOC'), label: 'BW', hint: 'BW', alertText: 'BW belum disi ', textUnit: 'gr', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});

  EditField efUniform =
      EditField(controller: GetXCreator.putEditFieldController('uniformDOC'), label: 'Uniformity', hint: 'Uniformity', alertText: 'Uniformity belum disi', textUnit: '%', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});
  ...
  late DateTimeField dtFinishDoc = DateTimeField(
      ...
      onDateTimeSelected: (time, dateField) {
        ...
        const String timeLimit = '12:00:00';
        final DateTime limit = DateFormat('HH:mm:ss').parse(timeLimit);
        final DateTime docTime = DateFormat('HH:mm:ss').parse(DateFormat('HH:mm:ss').format(time));
  ...
  EditField efDesc =
      EditField(controller: GetXCreator.putEditFieldController('efDesc'), label: 'Keterangan', hint: 'Keterangan', alertText: '', textUnit: '', maxInput: 500, inputType: TextInputType.multiline, height: 160, onTyping: (value, editField) {});
  ...
  late ButtonFill btYakin = ButtonFill(
      controller: GetXCreator.putButtonFillController('byYakin'),
      label: 'Yakin',
      onClick: () {
        Get.back();
        addChickin();
    ...
    return showModalBottomSheet(
        ...
        builder: (context) => Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  child: Column(children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          '${efReceiveDoc.getInput()} Ekor',
                          style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold),
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          DateFormat('HH:mm').format(dtTruckGo.getLastTimeSelected()),
                          style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold),
                        )
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          DateFormat('HH:mm').format(dtTruckCome.getLastTimeSelected()),
                          style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold),
                        )
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          DateFormat('dd/MM/yyyy - HH:mm').format(dtFinishDoc.getLastTimeSelected()),
                          style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold),
                        )
                      ],
                    ),
              ...
              Container(margin: const EdgeInsets.only(top: 24, left: 16, right: 16), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: btYakin), const SizedBox(width: 16), Expanded(child: btTidakYakin)])),
