...
class PulletInActivity extends GetView<PulletInController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        appBar: PreferredSize(preferredSize: const Size.fromHeight(60), child: AppBarFormForCoop(title: 'Pullet In', coop: controller.coop, hideCoopDetail: true)),
        bottomNavigationBar: controller.isLoading.isTrue || controller.isAlreadySubmit.isTrue
            ? const SizedBox()
            : Container(
                ...
                SingleChildScrollView(
                    child: Container(
                        ...
                        child: Column(children: [
                          ...
                          Container(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  ...
                                  Text(controller.request.value!.chickType != null ? controller.request.value!.chickType!.chickTypeName ?? '-' : '-',
                          ...
                          Row(children: [Expanded(child: controller.efPopulation), const SizedBox(width: 8), Expanded(child: controller.efAge)]),
                          Row(children: [Expanded(child: controller.efBw), const SizedBox(width: 8), Expanded(child: controller.efUniform)]),
                          Row(children: [Expanded(child: controller.dtTruckGo), const SizedBox(width: 8), Expanded(child: controller.dtTruckCome)]),
                          controller.dtFinishPulletIn,
                          controller.eaDesc,
                          controller.request.value!.hasFinishedDOCin == null || !controller.request.value!.hasFinishedDOCin!
                              ? Column(children: [
                                  controller.isLoadingSuratJalan.isTrue
                                      ? SizedBox(
                                          height: 50,
                                  ...
                                  controller.isLoadingFormPulletIn.isTrue
                                      ? SizedBox(
                                          height: 50,
                                          width: MediaQuery.of(context).size.width - 32,
                                          child: Padding(
                                  ...
                                  controller.isLoadingAnotherPullet.isTrue
                                      ? SizedBox(
                                          height: 50,
                                          width: MediaQuery.of(context).size.width - 32,
                                          child: Padding(
