...
class PulletInController extends GetxController {
  ...
  EditField efPopulation = EditField(controller: GetXCreator.putEditFieldController('pulletInPopulation'), label: 'Populasi', hint: '', alertText: '', textUnit: 'Ekor', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});

  EditField efAge = EditField(controller: GetXCreator.putEditFieldController('pulletInAge'), label: 'Umur', hint: '', alertText: '', textUnit: 'Minggu', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});

  EditField efBw = EditField(controller: GetXCreator.putEditFieldController('pulletInBw'), label: 'BW', hint: 'BW', alertText: 'Harus diisi..!', textUnit: 'gr', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});

  EditField efUniform =
      EditField(controller: GetXCreator.putEditFieldController('pulletInUniform'), label: 'Uniformity', hint: 'Uniformity', alertText: 'Harus diisi..!', textUnit: '%', maxInput: 20, inputType: TextInputType.number, onTyping: (value, control) {});
  ...
  EditAreaField eaDesc = EditAreaField(controller: GetXCreator.putEditAreaFieldController('pulletInDesc'), label: 'Keterangan', hint: 'Keterangan', alertText: '', textUnit: '', maxInput: 500, onTyping: (value, editField) {});
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Container(
                        ...
                        child: Column(children: [
                          ...
                          Row(
                              ...
                              children: [Text('Populasi', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text('${efPopulation.getInput()} Ekor', style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))]),
                          const SizedBox(height: 8),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Umur', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text('${efAge.getInput()} Minggu', style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))]),
                          const SizedBox(height: 8),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('BW', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text('${efBw.getInput()} gr', style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))]),
                          const SizedBox(height: 8),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Uniformity', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text('${efUniform.getInput()} %', style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))]),
                          const SizedBox(height: 8),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Jam Truck Berangkat', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text(dtTruckGo.getLastTimeSelectedText(), style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))],
                          ),
                          const SizedBox(height: 8),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Jam Truck Tiba', style: GlobalVar.greyTextStyle.copyWith(fontSize: 12)), Text(dtTruckCome.getLastTimeSelectedText(), style: GlobalVar.blackTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.bold))]),
                          const SizedBox(height: 8),
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text(
                              'Selesai Pullet In',
                    ...
                    Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Expanded(
                            child: ButtonFill(
                                controller: GetXCreator.putButtonFillController('btnAgreePulletIn'),
                                label: 'Yakin',
                                onClick: () {
                                  ...
                                  AuthImpl().get().then((auth) {
                                    if (auth != null) {
                                      ...
                                      final RequestChickin bodyPayload = generatePayload();
                                      Service.push(
                                          apiKey: 'productReportApi',
  ...
  RequestChickin generatePayload() {
    final RequestChickin requestChickin = RequestChickin();
