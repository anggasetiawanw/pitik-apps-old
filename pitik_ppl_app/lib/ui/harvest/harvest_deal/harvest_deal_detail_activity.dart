...
import '../../../route.dart';
import '../harvest_realization/bundle/harvest_realization_bundle.dart';
import 'harvest_deal_detail_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        bottomNavigationBar: controller.isLoading.isTrue
            ? const SizedBox()
            : controller.harvest.value != null && controller.harvest.value!.statusText != GlobalVar.REJECTED && controller.harvest.value!.statusText != GlobalVar.ABORT
                ? SizedBox(
                    child: Container(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Expanded(
                                  child: ButtonFill(
                                      ...
                                      onClick: () {
                                        GlobalVar.track('Click_button_realisasi_panen');
                                        Get.toNamed(RoutePage.harvestRealizationForm, arguments: HarvestRealizationBundle(getCoop: controller.coop, getHarvest: controller.harvest.value))!.then((value) => Get.back(result: true));
                                      })),
