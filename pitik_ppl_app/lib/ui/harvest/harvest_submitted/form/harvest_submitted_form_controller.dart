...
class HarvestSubmittedFormController extends GetxController {
        ...
        child: (key) => Column(
              ...
              children: [
                ...
                Row(
                    ...
                    children: [Expanded(child: minWeightFieldList[key]), Text('\ts/d\t', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black)), Expanded(child: maxWeightFieldList[key])]),
  ...
  void _increaseCard({required int index, Harvest? harvest}) {
    final int randomIndex = Random().nextInt(1000000);
    final EditField minWeightField = EditField(
        ...
        onTyping: (text, field) {
          final Harvest harvest = submissionField.controller.listData[index];
    ...
    final EditField maxWeightField = EditField(
    ...
    final EditField totalChickenField = EditField(
    ...
    final SpinnerField reasonField = SpinnerField(
  ...
  void sendHarvestSubmitted() => AuthImpl().get().then((auth) {
        if (auth != null) {
          Harvest? tempHarvest;
          final int index = submissionField.controller.listData.length - 1;
          ...
          if (submissionField.controller.listData.length > 1 || tempHarvest != null) {
            ...
            Get.snackbar(
              'Pesan',
              'Pengajuan masih kosong, silahkan isi minimal satu pengajuan..!',
  ...
  Future<void> _showBottomDialog({required Auth auth, Harvest? temptHarvest}) {
        ...
        builder: (context) => SingleChildScrollView(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Container(
                ...
                width: 60,
                height: 4,
                decoration: BoxDecoration(color: GlobalVar.outlineColor, borderRadius: BorderRadius.circular(2)),
              ),
              Container(
                ...
                Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('Rentang BW', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                          Text('${temptHarvest.minWeight == null ? '-' : temptHarvest.minWeight!.toStringAsFixed(1)} Kg s.d ${temptHarvest.maxWeight == null ? '-' : temptHarvest.maxWeight!.toStringAsFixed(1)} Kg',
                              style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                        ],
                      ),
                      const SizedBox(height: 8),
                      Row(
                        ...
                        children: [
                          Text('Jumlah Ayam', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                          Text('${temptHarvest.quantity != null ? Convert.toCurrencyWithoutDecimal(temptHarvest.quantity.toString(), '', '.') : '-'} Ekor',
                              style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                        ],
                      ),
                      const SizedBox(height: 16)
              ...
              Container(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Expanded(
                        child: ButtonFill(
                            controller: GetXCreator.putButtonFillController('byHarvestSubmittedYakin'),
                            label: 'Yakin',
                            onClick: () {
                              ...
                              final List<Harvest> harvestList = [];
                              ...
                              final Map<String, dynamic> bodyRequest = {'datePlanned': submittedDateField.controller.textSelected.value, 'harvestRequests': json.decode(Mapper.asJsonString(harvestList)!)};
