...
class HarvestCommon {
  static void getSubmittedList({required RxBool isLoading, required Coop coop, required RxList<Harvest?> harvestList, Function()? onCallBack, bool? isApproved}) =>
      _requestHarvestDataToServer(route: ListApi.getSubmitsHarvest, isLoading: isLoading, coop: coop, harvestList: harvestList, onCallBack: onCallBack, isApproved: isApproved);

  static void getDealList({required RxBool isLoading, required Coop coop, required RxList<Harvest?> harvestList, Function()? onCallBack}) =>
      _requestHarvestDataToServer(route: ListApi.getDealsHarvest, isLoading: isLoading, coop: coop, harvestList: harvestList, onCallBack: onCallBack);

  static void getRealizationList({required RxBool isLoading, required Coop coop, required RxList<Realization?> realizationList, Function()? onCallBack, bool? isApproved}) =>
      _requestHarvestDataToServer(route: ListApi.getRealizationHarvest, isRealization: true, isLoading: isLoading, coop: coop, realizationList: realizationList, onCallBack: onCallBack, isApproved: isApproved);

  static void _requestHarvestDataToServer(
      {required String route, required RxBool isLoading, required Coop coop, bool isRealization = false, RxList<Harvest?>? harvestList, RxList<Realization?>? realizationList, Function()? onCallBack, bool? isApproved}) {
    ...
    AuthImpl().get().then((auth) {
      if (auth != null) {
        ...
        final List<dynamic> body = ['Bearer ${auth.token}', auth.id, coop.farmingCycleId];
  ...
  static Widget createSubmittedHarvestCard({required int index, required Coop coop, required Function() onRefreshData, Harvest? harvest, Function()? onNavigate}) {
    if (harvest != null) {
      return Padding(
              ...
              child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(
                      ...
                      children: [Text('Pengajuan Panen', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: Colors.black)), _getStatusWidget(statusText: harvest.statusText == null ? '-' : harvest.statusText!)],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${harvest.minWeight == null ? '-' : harvest.minWeight!.toStringAsFixed(1)} Kg s.d ${harvest.maxWeight == null ? '-' : harvest.maxWeight!.toStringAsFixed(1)} Kg',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${harvest.quantity != null ? Convert.toCurrencyWithoutDecimal(harvest.quantity.toString(), '', '.') : '-'} Ekor',
                            style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                      ],
                    ),
                    const SizedBox(height: 8),
  ...
  static Widget createDealHarvestCard({required Coop coop, required Function() onRefreshData, Harvest? harvest}) {
    if (harvest != null) {
      return Padding(
          padding: const EdgeInsets.only(top: 8, bottom: 8, left: 16, right: 16),
          child: GestureDetector(
              ...
              child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [Text('Deal Panen', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: Colors.black)), _getStatusWidget(statusText: harvest.statusText == null ? '-' : harvest.statusText!)]),
                    const SizedBox(height: 12),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('Jumlah Ayam (Ekor)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                      Text('${harvest.quantity != null ? Convert.toCurrencyWithoutDecimal(harvest.quantity.toString(), '', '.') : '-'} Ekor', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                    ])
                  ]))));
    } else {
      return const SizedBox();
  ...
  static Widget createRealizationHarvestCard({required Coop coop, required Function() onRefreshData, Realization? realization, Function()? onNavigate}) {
    if (realization != null) {
      return Padding(
          padding: const EdgeInsets.only(top: 8, bottom: 8, left: 16, right: 16),
          child: GestureDetector(
              ...
              child: Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text('Rentang BW', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                        Text('${realization.minWeight == null ? '-' : realization.minWeight!.toStringAsFixed(1)} Kg s.d ${realization.maxWeight == null ? '-' : realization.maxWeight!.toStringAsFixed(1)} Kg',
                            style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('Jumlah Ayam (Ekor)', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)),
                      Text('${realization.quantity != null ? Convert.toCurrencyWithoutDecimal(realization.quantity.toString(), '', '.') : '-'} Ekor',
                          style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                    ])
                  ]))));
    } else {
