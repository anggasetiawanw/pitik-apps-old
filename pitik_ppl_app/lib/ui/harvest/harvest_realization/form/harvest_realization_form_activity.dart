...
import 'harvest_realization_form_controller.dart';
        ...
        body: Container(
            ...
            child: controller.isLoading.isTrue
                ...
                : ListView(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: controller.harvestHourField), const SizedBox(width: 8), Expanded(child: controller.ongoingHourField)]),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: controller.driverNameField), const SizedBox(width: 8), Expanded(child: controller.truckPlateField)]),
                    Container(
                        ...
                        child: Column(children: [
                          Container(
                            ...
                            decoration: const BoxDecoration(borderRadius: BorderRadius.only(topRight: Radius.circular(8), topLeft: Radius.circular(8)), color: GlobalVar.headerSku),
                          ...
                          Padding(
                              ...
                              child: Column(children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Expanded(child: controller.tonnageField), const SizedBox(width: 8), Expanded(child: controller.averageWeightField)]),
