...
class HarvestRealizationFormController extends GetxController {
  ...
  void _fillRealizationData() {
    ...
    driverNameField =
        EditField(controller: GetXCreator.putEditFieldController('harvestRealizationDriverName'), label: 'Nama Sopir', hint: 'Ketik disini', alertText: 'Oops nama sopir belum diisi', textUnit: '', maxInput: 100, onTyping: (text, field) {});

    truckPlateField =
        EditField(controller: GetXCreator.putEditFieldController('harvestRealizationTruckPlate'), label: 'Nopol Kendaraan', hint: 'Ketik disini', alertText: 'Oops nopol kendaraan belum diisi', textUnit: '', maxInput: 15, onTyping: (text, field) {});

    weighingNumberField = EditField(
        controller: GetXCreator.putEditFieldController('harvestRealizationWeighingNumber'), label: 'No. Data Timbang', hint: 'Ketik disini', alertText: 'Oops No. Data Timbang belum diisi', textUnit: '', maxInput: 100, onTyping: (text, field) {});
  ...
  void _pushHarvestRealizationToServer(Auth auth) {
    ...
    final String route = bundle.getRealization == null ? ListApi.saveHarvestRealization : ListApi.updateHarvestRealization;
    final List<dynamic> bodyRequest = ['Bearer ${auth.token}', auth.id];
    if (bundle.getRealization != null) {
    ...
    final RealizationRecord realizationRecord = RealizationRecord(
        weighingNumber: weighingNumberField.getInput(), tonnage: tonnageField.getInputNumber(), quantity: totalChickenField.getInputNumber()?.toInt(), averageWeight: averageWeightField.getInputNumber(), image: weighingMediaList[0]?.url);
                        ...
                        child: SingleChildScrollView(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                Text(totalChickenField.getInputNumber() != null ? '${Convert.toCurrencyWithoutDecimal(totalChickenField.getInputNumber()!.toString(), '', '.')} Ekor' : '-',
                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                Text(tonnageField.getInputNumber() != null ? '${Convert.toCurrencyWithDecimalAndPrecision(tonnageField.getInputNumber()!.toString(), '', '.', ',', 1)} Kg' : '-',
                                    style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                              ]),
                              const SizedBox(height: 8),
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                Text('Berat Rata-rata', style: TextStyle(color: GlobalVar.grayText, fontSize: 12, fontWeight: GlobalVar.medium)),
                                Text(averageWeightField.getInputNumber() != null ? '${Convert.toCurrencyWithDecimalAndPrecision(averageWeightField.getInputNumber()!.toString(), '', '.', ',', 1)} Kg' : '-',
                                    style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium))
                              ]),
                              ...
                              SizedBox(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Expanded(
                                        child: ButtonFill(
                                            controller: GetXCreator.putButtonFillController('btnSubmitHarvestRealization'),
                                            label: 'Yakin',
                                            onClick: () {
