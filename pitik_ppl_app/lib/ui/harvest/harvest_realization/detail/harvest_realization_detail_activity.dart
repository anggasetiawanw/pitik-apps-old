                                        ...
                                        children: [
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                    ...
                                                    Text(
                                                        controller.realization.quantity != null ? '${Convert.toCurrencyWithoutDecimal(controller.realization.quantity.toString(), '', '.')} Ekor' : '-',
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                    ...
                                                    Text(
                                                        controller.realization.tonnage != null ? '${Convert.toCurrencyWithDecimalAndPrecision(controller.realization.tonnage.toString(), '', '.', ',', 1)} Kg' : '-',
                                                        style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium)
                                                    )
                                                ]
                                            ),
                                            ...
                                            Row(
                                                ...
                                                children: [
                                                    ...
                                                    Text(
                                                        controller.realization.averageChickenWeighed != null ? '${Convert.toCurrencyWithDecimalAndPrecision(controller.realization.averageChickenWeighed!.toString(), '', '.', ',', 1)} Kg' : '-',
                                                        style: TextStyle(color: GlobalVar.black, fontSize: 12, fontWeight: GlobalVar.medium)
                                                    )
                                                ]
                                            )
