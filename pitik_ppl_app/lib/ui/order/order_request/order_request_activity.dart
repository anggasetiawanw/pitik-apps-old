                ...
                : ListView(
                    children: [
                      ...
                      controller.isFeed.isTrue
                          ? Column(
                              children: [controller.orderMultipleLogisticField, controller.isMerge.isTrue ? controller.orderCoopTargetLogisticField : const SizedBox(), const SizedBox(height: 16), controller.feedMultipleFormField],
                            )
                          : controller.coop.isOwnFarm != null && controller.coop.isOwnFarm!
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(borderRadius: const BorderRadius.only(topLeft: Radius.circular(10)), color: controller.isVendor.isTrue ? GlobalVar.primaryLight2 : GlobalVar.primaryLight),
                                            child: Column(
                                              children: [
                                                Container(
                                                    padding: const EdgeInsets.only(top: 12, bottom: 12),
                                                    child: Text('Vendor', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: controller.isVendor.isTrue ? GlobalVar.primaryOrange : GlobalVar.grayLightText))),
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            width: (MediaQuery.of(context).size.width / 2) - 16,
                                            decoration: BoxDecoration(borderRadius: const BorderRadius.only(topRight: Radius.circular(10)), color: controller.isVendor.isFalse ? GlobalVar.primaryLight2 : GlobalVar.primaryLight),
                                            child: Column(
                                              children: [
                                                Container(
                                                    padding: const EdgeInsets.only(top: 12, bottom: 12),
                                                    child: Text('Unit', style: GlobalVar.whiteTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.medium, color: controller.isVendor.isFalse ? GlobalVar.primaryOrange : GlobalVar.grayLightText))),
                              ...
                              : Column(
                                  children: [const SizedBox(height: 16), controller.ovkMultipleFormField],
                                )
                    ],
                  ))));
  }
