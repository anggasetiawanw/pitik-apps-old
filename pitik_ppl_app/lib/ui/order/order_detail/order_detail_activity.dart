                ...
                : ListView(children: [
                    Container(
                        ...
                        child: Column(children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Detail Order', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: Colors.black)), controller.getStatus()]),
                          const SizedBox(height: 12),
                          Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [Text('Tanggal Order', style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.grayText)), controller.getOrderDate()]),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text(
                                controller.procurement.value.type == null
                                    ? '-'
                                    : controller.procurement.value.type == 'pakan'
                                        ? 'Pakan'
                                        : 'OVK',
                              ...
                              ? Column(
                                  children: [
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      Text(
                                          controller.procurement.value.mergedLogistic == null
                                              ? '-'
                                              : controller.procurement.value.mergedLogistic!
                                                  ? 'Ya'
                                                  : 'Tidak',
                                          style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                    ]),
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      Text(controller.procurement.value.mergedLogisticCoopName == null ? '-' : controller.procurement.value.mergedLogisticCoopName!,
                                          style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                    ])
                                  ],
                                )
                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                          ...
                                          Text(
                                              controller.procurement.value.details.isNotEmpty && controller.procurement.value.internalOvkTransferRequest != null
                                                  ? 'Vendor & Unit'
                                                  : controller.procurement.value.details.isNotEmpty && controller.procurement.value.internalOvkTransferRequest == null
                                                      ? 'Vendor'
                                                      : controller.procurement.value.details.isEmpty && controller.procurement.value.internalOvkTransferRequest != null
                                                          ? 'Unit'
                                                          : '-',
                                              style: GlobalVar.subTextStyle.copyWith(fontSize: 12, fontWeight: GlobalVar.medium, color: GlobalVar.black))
                                        ]),
                    ...
                    controller.procurement.value.internalOvkTransferRequest != null
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Total OVK Unit', style: GlobalVar.subTextStyle.copyWith(fontSize: 14, fontWeight: GlobalVar.bold, color: GlobalVar.black)),
                              const SizedBox(height: 12),
