...
class IssueReportForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    IssueReportFormController controller = Get.put(IssueReportFormController(context: context));
    return Obx(
      () => Scaffold(
                          ...
                          ? SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [const CircularProgressIndicator(color: GlobalVar.primaryOrange), const SizedBox(width: 16), Text('Upload data issue...', style: TextStyle(color: GlobalVar.primaryOrange, fontSize: 14, fontWeight: GlobalVar.medium))],
                                ),
                              ))
                          : controller.mfPhoto,
                    ],
